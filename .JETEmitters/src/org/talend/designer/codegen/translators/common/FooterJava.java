...
public class FooterJava
{
  ...
  protected final String TEXT_114 = NL + NL + "        try {" + NL + "            //call job/subjob with an existing context, like: --context=production. if without this parameter, there will use the default context instead." + NL + "            java.io.InputStream inContext = ";
  ...
  protected final String TEXT_138 = ");" + NL + "                                    } catch (java.lang.RuntimeException e) {" + NL + "                                        //do nothing" + NL + "                                    }" + NL + "                                } else {" + NL + "                                    context.";
  protected final String TEXT_139 = "_value;" + NL + "                                    context.put(\"";
  protected final String TEXT_140 = ");" + NL + "                                }" + NL + "                            }";
  protected final String TEXT_141 = NL + "                            String context_";
  protected final String TEXT_142 = "\");" + NL + "                            try{" + NL + "                                if (context_";
  protected final String TEXT_143 = "_value == null){" + NL + "                                    context_";
  protected final String TEXT_144 = "_value = \"\";" + NL + "                                }" + NL + "                                int context_";
  protected final String TEXT_145 = "_pos = context_";
  protected final String TEXT_146 = "_value.indexOf(\";\");" + NL + "                                String context_";
  protected final String TEXT_147 = "_pattern =  \"yyyy-MM-dd HH:mm:ss\";" + NL + "                                if(context_";
  protected final String TEXT_148 = "_pos > -1){" + NL + "                                    context_";
  protected final String TEXT_149 = "_pattern = context_";
  protected final String TEXT_150 = "_value.substring(0, context_";
  protected final String TEXT_151 = "_pos);" + NL + "                                    context_";
  protected final String TEXT_152 = "_value = context_";
  protected final String TEXT_153 = "_value.substring(context_";
  protected final String TEXT_154 = "_pos + 1);" + NL + "                                }" + NL + "" + NL + "                                context.";
  protected final String TEXT_155 = "=(java.util.Date)(new java.text.SimpleDateFormat(context_";
  protected final String TEXT_156 = "_pattern).parse(context_";
  protected final String TEXT_157 = "_value));" + NL + "" + NL + "                            } catch(ParseException e) {" + NL + "                                try { ";
  protected final String TEXT_158 = NL + "                                    long context_";
  protected final String TEXT_159 = "_longValue = Long.valueOf(context_";
  protected final String TEXT_160 = "_value);" + NL + "                                    context.";
  protected final String TEXT_161 = " = new java.util.Date(context_";
  protected final String TEXT_162 = "_longValue);" + NL + "                                } catch (NumberFormatException cantParseToLongException) {";
  protected final String TEXT_163 = NL + "                                        log.warn(String.format(\"";
  protected final String TEXT_164 = "\", \"Can't parse date string: \" + e.getMessage() + \" and long: \" + cantParseToLongException.getMessage()));";
  protected final String TEXT_165 = NL + "                                        System.err.println(String.format(\"";
  protected final String TEXT_166 = NL + "                                    context.";
  protected final String TEXT_167 = "=null;" + NL + "                                }" + NL + "                            }";
  protected final String TEXT_168 = NL + "                            context.";
  protected final String TEXT_169 = "=(";
  protected final String TEXT_170 = ") context.getProperty(\"";
  protected final String TEXT_171 = "= new java.text.StringCharacterIterator(context.getProperty(\"";
  protected final String TEXT_172 = "\")).first();";
  protected final String TEXT_173 = NL + "                            try{" + NL + "                                context.";
  protected final String TEXT_174 = "=routines.system.ParserUtils.parseTo_";
  protected final String TEXT_175 = " (context.getProperty(\"";
  protected final String TEXT_176 = "\"));" + NL + "                            } catch(NumberFormatException e){";
  protected final String TEXT_177 = NL + "                                log.warn(String.format(\"";
  protected final String TEXT_178 = "\", e.getMessage()));";
  protected final String TEXT_179 = NL + "                                System.err.println(String.format(\"";
  protected final String TEXT_180 = NL + "                                context.";
  protected final String TEXT_181 = "=null;" + NL + "                            }";
  protected final String TEXT_182 = NL + "                        }";
  protected final String TEXT_183 = NL + "                } ";
  protected final String TEXT_184 = NL + "                public void processAllContext() {";
  protected final String TEXT_185 = NL + "                        processContext_";
  protected final String TEXT_186 = "();";
  protected final String TEXT_187 = NL + "                }" + NL + "            }" + NL + "" + NL + "            new ContextProcessing().processAllContext();" + NL + "        } catch (java.io.IOException ie) {" + NL + "            System.err.println(\"Could not load context \"+contextStr);" + NL + "            ie.printStackTrace();" + NL + "        }" + NL + "" + NL + "        // get context value from parent directly" + NL + "        if (parentContextMap != null && !parentContextMap.isEmpty()) {";
  protected final String TEXT_188 = "if (parentContextMap.containsKey(\"";
  protected final String TEXT_189 = "\")) {" + NL + "                context.";
  protected final String TEXT_190 = " = (";
  protected final String TEXT_191 = ") parentContextMap.get(\"";
  protected final String TEXT_192 = "\");" + NL + "            }";
  protected final String TEXT_193 = NL + "        }" + NL + "" + NL + "        //Resume: init the resumeUtil" + NL + "        resumeEntryMethodName = ResumeUtil.getResumeEntryMethodName(resuming_checkpoint_path);" + NL + "        resumeUtil = new ResumeUtil(resuming_logs_dir_path, isChildJob, rootPid);" + NL + "        resumeUtil.initCommonInfo(pid, rootPid, fatherPid, projectName, jobName, contextStr, jobVersion);" + NL + "" + NL + "\t\tList<String> parametersToEncrypt = new java.util.ArrayList<String>();";
  protected final String TEXT_194 = NL + "\t\t\tparametersToEncrypt.add(\"";
  protected final String TEXT_195 = NL + "        //Resume: jobStart" + NL + "        resumeUtil.addLog(\"JOB_STARTED\", \"JOB:\" + jobName, parent_part_launcher, Thread.currentThread().getId() + \"\", \"\",\"\",\"\",\"\",resumeUtil.convertToJsonText(context,parametersToEncrypt));" + NL;
  ...
  protected final String TEXT_198 = NL + "    try {" + NL + "        runTrace.openSocket(!isChildJob);" + NL + "        runTrace.startThreadTrace(clientHost, portTraces);" + NL + "        if (runTrace.isPause()) {" + NL + "\t\t\twhile (runTrace.isPause()) {" + NL + "\t\t\t\tThread.sleep(100);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "    } catch (java.io.IOException ioException) {" + NL + "        ioException.printStackTrace();" + NL + "    } catch (InterruptedException e) {" + NL + "\t\t\te.printStackTrace();" + NL + "\t}";
  protected final String TEXT_199 = NL + "\t";
  protected final String TEXT_200 = NL + "\t    java.util.concurrent.ConcurrentHashMap<Object, Object> concurrentHashMap = new java.util.concurrent.ConcurrentHashMap<Object, Object>();" + NL + "\t    globalMap.put(\"concurrentHashMap\", concurrentHashMap);" + NL + "\t";
  protected final String TEXT_201 = NL + NL + "    long startUsedMemory = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();" + NL + "    long endUsedMemory = 0;" + NL + "    long end = 0;" + NL + "" + NL + "    startTime = System.currentTimeMillis();";
  protected final String TEXT_202 = NL + "        java.net.ProxySelector proxySelectorOnStartJob = java.net.ProxySelector.getDefault();";
  protected final String TEXT_203 = ".addMessage(\"begin\");";
  protected final String TEXT_204 = NL + NL + "this.globalResumeTicket = true;//to run tPreJob" + NL;
  protected final String TEXT_205 = NL + "    System.err.println(\"Only one hadoop configuration is allowed in one job!\");";
  protected final String TEXT_206 = NL + "        try {";
  protected final String TEXT_207 = NL + "            ";
  protected final String TEXT_208 = "Process(globalMap);" + NL + "        } catch (java.lang.Exception e) {" + NL + "            e.printStackTrace();" + NL + "        }";
  protected final String TEXT_209 = NL + "\t\tif(enableLogStash) {" + NL + "\t        ";
  protected final String TEXT_210 = ".addJobStartMessage();" + NL + "\t        try {" + NL + "\t            ";
  protected final String TEXT_211 = "Process(globalMap);" + NL + "\t        } catch (java.lang.Exception e) {" + NL + "\t            e.printStackTrace();" + NL + "\t        }" + NL + "        }";
  protected final String TEXT_212 = NL + NL + "this.globalResumeTicket = false;//to run others jobs" + NL;
  protected final String TEXT_213 = "final Thread launchingThread = Thread.currentThread();";
  protected final String TEXT_214 = NL + "        runningThreadCount.add(1);" + NL + "        new Thread(){" + NL + "            public void run() {" + NL + "                java.util.Map threadRunResultMap = new java.util.HashMap();" + NL + "                threadRunResultMap.put(\"errorCode\", null);" + NL + "                threadRunResultMap.put(\"status\", \"\");" + NL + "                threadLocal.set(threadRunResultMap);" + NL;
  protected final String TEXT_215 = NL + "                ";
  protected final String TEXT_216 = NL + "                finally {" + NL + "                    Integer localErrorCode = (Integer)(((java.util.Map)threadLocal.get()).get(\"errorCode\"));" + NL + "                    String localStatus = (String)(((java.util.Map)threadLocal.get()).get(\"status\"));" + NL + "                    if (localErrorCode != null) {" + NL + "                        if (errorCode == null || localErrorCode.compareTo(errorCode) > 0) {" + NL + "                           errorCode = localErrorCode;" + NL + "                        }" + NL + "                    }" + NL + "                    if (!status.equals(\"failure\")){" + NL + "                        status = localStatus;" + NL + "                    }" + NL + "" + NL + "                    if (\"true\".equals(((java.util.Map) threadLocal.get()).get(\"JobInterrupted\"))) {" + NL + "                        launchingThread.interrupt();" + NL + "                    }" + NL + "" + NL + "                    runningThreadCount.add(-1);" + NL + "                }" + NL + "            }" + NL + "        }.start();" + NL;
  protected final String TEXT_217 = NL + "    boolean interrupted = false;" + NL + "    while (runningThreadCount.getCount() > 0) {" + NL + "        try {" + NL + "            Thread.sleep(10);" + NL + "        } catch (java.lang.InterruptedException e) {" + NL + "            interrupted = true;" + NL + "        } catch (java.lang.Exception e) {" + NL + "            e.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "" + NL + "    if (interrupted) {" + NL + "        Thread.currentThread().interrupt();" + NL + "    }" + NL + NL;
  protected final String TEXT_218 = NL + NL + "this.globalResumeTicket = true;//to run tPostJob" + NL;
  protected final String TEXT_219 = NL + "        java.net.ProxySelector.setDefault(proxySelectorOnStartJob);";
  protected final String TEXT_220 = NL + "        end = System.currentTimeMillis();" + NL + "" + NL + "        if (watch) {" + NL + "            System.out.println((end-startTime)+\" milliseconds\");" + NL + "        }" + NL + "" + NL + "        endUsedMemory = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();" + NL + "        if (false) {" + NL + "            System.out.println((endUsedMemory - startUsedMemory) + \" bytes memory increase when running : ";
  protected final String TEXT_221 = "\");" + NL + "        }";
  protected final String TEXT_222 = ".addMessage(status==\"\"?\"end\":status, (end-startTime));" + NL + "        try {";
  protected final String TEXT_223 = ".addJobEndMessage(startTime, end, status);" + NL + "\t        try {" + NL + "\t            ";
  protected final String TEXT_224 = NL + "    closeJmsConnections();";
  protected final String TEXT_225 = NL + "    closeScpConnections();";
  protected final String TEXT_226 = NL + "if (execStat) {" + NL + "    runStat.updateStatOnJob(RunStat.JOBEND, fatherNode);" + NL + "    runStat.stopThreadStat();" + NL + "}";
  protected final String TEXT_227 = NL + "        runTrace.stopThreadTrace();";
  protected final String TEXT_228 = NL + "    int returnCode = 0;" + NL;
  protected final String TEXT_229 = NL + "        Integer localErrorCode = (Integer)(((java.util.Map)threadLocal.get()).get(\"errorCode\"));" + NL + "        String localStatus = (String)(((java.util.Map)threadLocal.get()).get(\"status\"));" + NL + "        if (localErrorCode != null) {" + NL + "            if (errorCode == null || localErrorCode.compareTo(errorCode) > 0) {" + NL + "                   errorCode = localErrorCode;" + NL + "            }" + NL + "        }" + NL + "        if (localStatus != null && !status.equals(\"failure\")){" + NL + "            status = localStatus;" + NL + "        }";
  ...
  protected final String TEXT_231 = NL + "    closeSqlDbConnections();";
  protected final String TEXT_232 = NL + "    closeCassandraConnections();";
  protected final String TEXT_233 = NL + "    closeHBaseConnections();";
  protected final String TEXT_234 = NL + "    closeFtpConnections();";
  protected final String TEXT_235 = NL + "    closeS3Connections();";
  protected final String TEXT_236 = NL + "    closeLDAPConnections();";
  protected final String TEXT_237 = NL + "    closeMDMConnections();";
  protected final String TEXT_238 = NL + "    closePaloConnections();";
  protected final String TEXT_239 = NL + "    closeEXistConnections();";
  protected final String TEXT_240 = NL + "    closeGSConnections();";
  protected final String TEXT_241 = NL + NL + NL + "    }" + NL;
  protected final String TEXT_242 = NL + "    private void closeJmsConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_243 = NL + "            obj_conn = globalMap.remove(\"connection_";
  protected final String TEXT_244 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((javax.jms.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_245 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_246 = NL + "    private void closeScpConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_247 = NL + "            obj_conn = globalMap.remove(\"conn_";
  protected final String TEXT_248 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((ch.ethz.ssh2.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_249 = NL + "    private void closeSqlDbConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_250 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((java.sql.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_251 = NL + "    private void closeCassandraConnections() {" + NL + "        try {" + NL + "            Object obj_cluster;" + NL + "            Object obj_conn;";
  protected final String TEXT_252 = NL + "            obj_cluster = globalMap.remove(\"cluster_";
  protected final String TEXT_253 = "\");" + NL + "            obj_conn = globalMap.remove(\"connection_";
  protected final String TEXT_254 = "\");" + NL + "            if(obj_conn != null) {" + NL + "                ((com.datastax.driver.core.Session) obj_conn).close();" + NL + "            }" + NL + "            if(obj_cluster != null) {" + NL + "                ((com.datastax.driver.core.Cluster) obj_cluster).close();" + NL + "            }";
  protected final String TEXT_255 = NL + "            obj_conn = globalMap.remove(\"cluster_";
  protected final String TEXT_256 = "\");" + NL + "            if(obj_conn!=null) {" + NL + "                ((me.prettyprint.hector.api.Cluster) obj_conn).getConnectionManager().shutdown();" + NL + "            }";
  protected final String TEXT_257 = NL + "    private void closeHBaseConnections() {" + NL + "        try {";
  protected final String TEXT_258 = NL + "   \t\t\torg.apache.hadoop.conf.Configuration conn_";
  protected final String TEXT_259 = " =(org.apache.hadoop.conf.Configuration)globalMap.get(\"conn_";
  protected final String TEXT_260 = "\");" + NL + "\t\t\tif(conn_";
  protected final String TEXT_261 = " != null )" + NL + "\t        {" + NL + "\t\t\t";
  protected final String TEXT_262 = NL + "                                org.apache.hadoop.hbase.client.HConnection hConnection_";
  protected final String TEXT_263 = " = org.apache.hadoop.hbase.client.HConnectionManager.getConnection(conn_";
  protected final String TEXT_264 = NL + "                                org.apache.hadoop.hbase.client.Connection hConnection_";
  protected final String TEXT_265 = " = org.apache.hadoop.hbase.client.ConnectionFactory.createConnection(conn_";
  protected final String TEXT_266 = NL + "\t\t        if ((hConnection_";
  protected final String TEXT_267 = " != null) && (!hConnection_";
  protected final String TEXT_268 = ".isClosed())) {" + NL + "\t\t\t\t    hConnection_";
  protected final String TEXT_269 = ".close();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_270 = NL + "\t\t\t\torg.apache.hadoop.hbase.client.HConnectionManager.deleteConnection(conn_";
  protected final String TEXT_271 = ",true);" + NL + "\t\t\t";
  protected final String TEXT_272 = NL + "\t\t\t}" + NL + "      globalMap.remove(\"conn_";
  protected final String TEXT_273 = "\");" + NL + "\t";
  protected final String TEXT_274 = NL + "    private void closeFtpConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_275 = "\");" + NL + "            if (obj_conn != null) {";
  protected final String TEXT_276 = NL + "                ((com.jcraft.jsch.ChannelSftp) obj_conn).quit();";
  protected final String TEXT_277 = NL + "                ((org.apache.commons.net.ftp.FTPClient) obj_conn).disconnect();";
  protected final String TEXT_278 = NL + "            }";
  protected final String TEXT_279 = NL + "    private void closeS3Connections() {" + NL + "        try {";
  protected final String TEXT_280 = NL + "    \tcom.amazonaws.services.s3.AmazonS3Client conn_";
  protected final String TEXT_281 = " = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get(\"conn_";
  protected final String TEXT_282 = "\");" + NL + "\t    if(conn_";
  protected final String TEXT_283 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_284 = ".shutdown();" + NL + "\t\t}";
  protected final String TEXT_285 = NL + "    private void closeLDAPConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_286 = "\");" + NL + "            if (obj_conn != null) {" + NL + "                ((javax.naming.ldap.InitialLdapContext) obj_conn).close();" + NL + "            }";
  protected final String TEXT_287 = NL + "    private void closeMDMConnections() {" + NL + "        try {" + NL + "            java.util.Iterator keySets = globalMap.keySet().iterator();" + NL + "            while (keySets.hasNext()) {" + NL + "                String key = keySets.next().toString();" + NL + "                if (key.startsWith(\"TMDMService_tMDMConnection_\")) {" + NL + "                    org.talend.mdm.webservice.TMDMService service = (org.talend.mdm.webservice.TMDMService)globalMap.get(key);" + NL + "                    if (service != null) {" + NL + "                        service.logout(new org.talend.mdm.webservice.WSLogout());" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_288 = NL + NL;
  protected final String TEXT_289 = NL + "    private void closePaloConnections() {" + NL + "        try {";
  protected final String TEXT_290 = NL + "    \torg.talend.jpalo.paloconnection pConn_";
  protected final String TEXT_291 = " = (org.talend.jpalo.paloconnection)globalMap.get(\"pConn_";
  protected final String TEXT_292 = "\");" + NL + "\t    if(pConn_";
  protected final String TEXT_293 = " !=null){" + NL + "\t\t\t\t\tpConn_";
  protected final String TEXT_294 = ".logout();" + NL + "" + NL + "\t\t}";
  protected final String TEXT_295 = NL + "    private void closeEXistConnections() {" + NL + "        try {";
  protected final String TEXT_296 = NL + "\t\torg.xmldb.api.base.Collection col_";
  protected final String TEXT_297 = " = (org.xmldb.api.base.Collection)globalMap.get(\"col_";
  protected final String TEXT_298 = "\");" + NL + "\t    if(col_";
  protected final String TEXT_299 = " !=null){" + NL + "\t\t\t\t\tcol_";
  protected final String TEXT_300 = ".close();" + NL + "" + NL + "\t\t}";
  protected final String TEXT_301 = NL + "    private void closeGSConnections() {" + NL + "        try {";
  protected final String TEXT_302 = NL + NL + "    org.jets3t.service.impl.rest.httpclient.GoogleStorageService service_";
  protected final String TEXT_303 = " =" + NL + "            (org.jets3t.service.impl.rest.httpclient.GoogleStorageService)globalMap.get(\"service_";
  protected final String TEXT_304 = "\");" + NL + "    if(service_";
  protected final String TEXT_305 = " !=null){" + NL + "            service_";
  protected final String TEXT_306 = ".shutdown();" + NL + "    }";
  protected final String TEXT_307 = NL + "        //Don't need to close storage when use google storage api";
  protected final String TEXT_308 = NL + NL + "    private java.util.Map<String, Object> getSharedConnections4REST() {" + NL + "        java.util.Map<String, Object> connections = new java.util.HashMap<String, Object>();";
  protected final String TEXT_309 = NL + "            connections.put(\"connection_";
  protected final String TEXT_310 = "\", globalMap.get(\"connection_";
  protected final String TEXT_311 = "\"));" + NL + "            connections.put(\"session_";
  protected final String TEXT_312 = "\", globalMap.get(\"session_";
  protected final String TEXT_313 = "\"));";
  protected final String TEXT_314 = NL + "            connections.put(\"conn_";
  protected final String TEXT_315 = "\", globalMap.get(\"conn_";
  protected final String TEXT_316 = "\"));" + NL + "            connections.put(\"cluster_";
  protected final String TEXT_317 = "\", globalMap.get(\"cluster_";
  protected final String TEXT_318 = NL + "            connections.put(\"cluster_";
  protected final String TEXT_319 = "\"));" + NL + "            connections.put(\"connBaseDN_";
  protected final String TEXT_320 = "\", globalMap.get(\"connBaseDN_";
  protected final String TEXT_321 = NL + "            connections.put(\"mdmUrl_";
  protected final String TEXT_322 = "\", globalMap.get(\"mdmUrl_";
  protected final String TEXT_323 = "\"));" + NL + "            connections.put(\"username_";
  protected final String TEXT_324 = "\", globalMap.get(\"username_";
  protected final String TEXT_325 = "\"));" + NL + "            connections.put(\"password_";
  protected final String TEXT_326 = "\", globalMap.get(\"password_";
  protected final String TEXT_327 = "\"));" + NL + "            connections.put(\"useTransaction_";
  protected final String TEXT_328 = "\", globalMap.get(\"useTransaction_";
  protected final String TEXT_329 = "\"));" + NL + "            connections.put(\"useClientTranId_";
  protected final String TEXT_330 = "\", globalMap.get(\"useClientTranId_";
  protected final String TEXT_331 = NL + "            connections.put(\"p_";
  protected final String TEXT_332 = "\", globalMap.get(\"p_";
  protected final String TEXT_333 = "\"));" + NL + "            connections.put(\"pConn_";
  protected final String TEXT_334 = "\", globalMap.get(\"pConn_";
  protected final String TEXT_335 = NL + "            connections.put(\"col_";
  protected final String TEXT_336 = "\", globalMap.get(\"col_";
  protected final String TEXT_337 = NL + "            connections.put(\"";
  protected final String TEXT_338 = "_connection\", globalMap.get(\"";
  protected final String TEXT_339 = "_connection\"));" + NL + "            connections.put(\"";
  protected final String TEXT_340 = "_COMPONENT_RUNTIME_PROPERTIES\", globalMap.get(\"";
  protected final String TEXT_341 = "_COMPONENT_RUNTIME_PROPERTIES\"));";
  protected final String TEXT_342 = NL + "            connections.put(\"service_";
  protected final String TEXT_343 = "\", globalMap.get(\"service_";
  protected final String TEXT_344 = NL + NL + NL + "        return connections;" + NL + "    }" + NL + "" + NL + "    private void evalParam(String arg) {" + NL + "        if (arg.startsWith(\"--resuming_logs_dir_path\")) {" + NL + "            resuming_logs_dir_path = arg.substring(25);" + NL + "        } else if (arg.startsWith(\"--resuming_checkpoint_path\")) {" + NL + "            resuming_checkpoint_path = arg.substring(27);" + NL + "        } else if (arg.startsWith(\"--parent_part_launcher\")) {" + NL + "            parent_part_launcher = arg.substring(23);" + NL + "        } else if (arg.startsWith(\"--watch\")) {" + NL + "            watch = true;" + NL + "        } else if (arg.startsWith(\"--stat_port=\")) {" + NL + "            String portStatsStr = arg.substring(12);" + NL + "            if (portStatsStr != null && !portStatsStr.equals(\"null\")) {" + NL + "                portStats = Integer.parseInt(portStatsStr);" + NL + "            }" + NL + "        } else if (arg.startsWith(\"--trace_port=\")) {" + NL + "            portTraces = Integer.parseInt(arg.substring(13));" + NL + "        } else if (arg.startsWith(\"--client_host=\")) {" + NL + "            clientHost = arg.substring(14);" + NL + "        } else if (arg.startsWith(\"--context=\")) {" + NL + "            contextStr = arg.substring(10);" + NL + "            isDefaultContext = false;" + NL + "        } else if (arg.startsWith(\"--father_pid=\")) {" + NL + "            fatherPid = arg.substring(13);" + NL + "        } else if (arg.startsWith(\"--root_pid=\")) {" + NL + "            rootPid = arg.substring(11);" + NL + "        } else if (arg.startsWith(\"--father_node=\")) {" + NL + "            fatherNode = arg.substring(14);" + NL + "        } else if (arg.startsWith(\"--pid=\")) {" + NL + "            pid = arg.substring(6);" + NL + "        } else if (arg.startsWith(\"--context_type\")) {" + NL + "            String keyValue = arg.substring(15);" + NL + "\t\t\tint index = -1;" + NL + "            if (keyValue != null && (index = keyValue.indexOf('=')) > -1) {" + NL + "                if (fatherPid==null) {" + NL + "                    context_param.setContextType(keyValue.substring(0, index), replaceEscapeChars(keyValue.substring(index + 1)));" + NL + "                } else { // the subjob won't escape the especial chars" + NL + "                    context_param.setContextType(keyValue.substring(0, index), keyValue.substring(index + 1) );" + NL + "                }" + NL + "" + NL + "            }" + NL + "" + NL + "\t\t} else if (arg.startsWith(\"--context_param\")) {" + NL + "            String keyValue = arg.substring(16);" + NL + "            int index = -1;" + NL + "            if (keyValue != null && (index = keyValue.indexOf('=')) > -1) {" + NL + "                if (fatherPid==null) {" + NL + "                    context_param.put(keyValue.substring(0, index), replaceEscapeChars(keyValue.substring(index + 1)));" + NL + "                } else { // the subjob won't escape the especial chars" + NL + "                    context_param.put(keyValue.substring(0, index), keyValue.substring(index + 1) );" + NL + "                }" + NL + "            }" + NL + "        } else if (arg.startsWith(\"--log4jLevel=\")) {" + NL + "            log4jLevel = arg.substring(13);" + NL + "\t\t} else if (arg.startsWith(\"--audit.enabled\") && arg.contains(\"=\")) {//for trunjob call" + NL + "\t\t    final int equal = arg.indexOf('=');" + NL + "\t\t\tfinal String key = arg.substring(\"--\".length(), equal);" + NL + "\t\t\tSystem.setProperty(key, arg.substring(equal + 1));" + NL + "\t\t}" + NL + "    }" + NL + "    " + NL + "    private static final String NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY = \"<TALEND_NULL>\";" + NL + "" + NL + "    private final String[][] escapeChars = {" + NL + "        {\"\\\\\\\\\",\"\\\\\"},{\"\\\\n\",\"\\n\"},{\"\\\\'\",\"\\'\"},{\"\\\\r\",\"\\r\"}," + NL + "        {\"\\\\f\",\"\\f\"},{\"\\\\b\",\"\\b\"},{\"\\\\t\",\"\\t\"}" + NL + "        };" + NL + "    private String replaceEscapeChars (String keyValue) {" + NL + "" + NL + "\t\tif (keyValue == null || (\"\").equals(keyValue.trim())) {" + NL + "\t\t\treturn keyValue;" + NL + "\t\t}" + NL + "" + NL + "\t\tStringBuilder result = new StringBuilder();" + NL + "\t\tint currIndex = 0;" + NL + "\t\twhile (currIndex < keyValue.length()) {" + NL + "\t\t\tint index = -1;" + NL + "\t\t\t// judege if the left string includes escape chars" + NL + "\t\t\tfor (String[] strArray : escapeChars) {" + NL + "\t\t\t\tindex = keyValue.indexOf(strArray[0],currIndex);" + NL + "\t\t\t\tif (index>=0) {" + NL + "" + NL + "\t\t\t\t\tresult.append(keyValue.substring(currIndex, index + strArray[0].length()).replace(strArray[0], strArray[1]));" + NL + "\t\t\t\t\tcurrIndex = index + strArray[0].length();" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t\t\t// if the left string doesn't include escape chars, append the left into the result" + NL + "\t\t\tif (index < 0) {" + NL + "\t\t\t\tresult.append(keyValue.substring(currIndex));" + NL + "\t\t\t\tcurrIndex = currIndex + keyValue.length();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "" + NL + "\t\treturn result.toString();" + NL + "    }" + NL + "" + NL + "    public Integer getErrorCode() {" + NL + "        return errorCode;" + NL + "    }" + NL + "" + NL + "" + NL + "    public String getStatus() {" + NL + "        return status;" + NL + "    }" + NL + "" + NL + "    ResumeUtil resumeUtil = null;" + NL + "}";
