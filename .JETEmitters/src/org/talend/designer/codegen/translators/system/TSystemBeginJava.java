...
public class TSystemBeginJava
{
  ...
  protected final String TEXT_54 = "command_";
  protected final String TEXT_55 = ",env_";
  protected final String TEXT_56 = ",new java.io.File(";
  protected final String TEXT_57 = "));";
  protected final String TEXT_58 = NL + NL + "globalMap.remove(\"";
  protected final String TEXT_59 = "_OUTPUT\");" + NL + "globalMap.remove(\"";
  protected final String TEXT_60 = "_ERROROUTPUT\");" + NL + "" + NL + "Thread normal_";
  protected final String TEXT_61 = " = new Thread() {" + NL + "\tpublic void run() {" + NL + "\t\ttry {" + NL + "\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps_";
  protected final String TEXT_62 = ".getInputStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {";
  protected final String TEXT_63 = NL + "\t\t\t\t\t";
  protected final String TEXT_64 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_65 = " - Sending the standard output to the console.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_66 = NL + "\t\t\t\t\tSystem.out.println(line);";
  protected final String TEXT_67 = " - Sending the standard output to the global variable '";
  protected final String TEXT_68 = "_OUTPUT'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_69 = NL + "\t\t\t\t\tif (globalMap.get(\"";
  protected final String TEXT_70 = "_OUTPUT\") != null) {" + NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_71 = "_OUTPUT\", (String)globalMap.get(\"";
  protected final String TEXT_72 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_73 = "_OUTPUT\", line);" + NL + "\t\t\t\t\t}";
  protected final String TEXT_74 = NL + "\t\t\tlog.debug(\"";
  protected final String TEXT_75 = " - Sending the standard output to both the console and the global variable '";
  protected final String TEXT_76 = "_OUTPUT'.\");" + NL + "\t\t";
  protected final String TEXT_77 = NL + "        System.out.println(line);" + NL + "        " + NL + "        \tif (globalMap.get(\"";
  protected final String TEXT_78 = "_OUTPUT\", line);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "    \t ";
  protected final String TEXT_79 = " - Sending the standard output to a column of the schema.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_80 = NL + "\t\t\t\t\toutput_";
  protected final String TEXT_81 = ".add(line);";
  protected final String TEXT_82 = NL + "\t\t\t\t}" + NL + "\t\t\t} finally {" + NL + "\t\t\t\treader.close();" + NL + "\t\t\t}" + NL + "\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t";
  protected final String TEXT_83 = NL + "\t\t\t\tlog.error(\"";
  protected final String TEXT_84 = " - \"  + ioe.getMessage());" + NL + "\t\t\t";
  protected final String TEXT_85 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};";
  protected final String TEXT_86 = " - Executing the command.\");" + NL + "\tlog.info(\"";
  protected final String TEXT_87 = " - Command to execute: '\" + ";
  protected final String TEXT_88 = "commandArrayForLog_";
  protected final String TEXT_89 = NL + "normal_";
  protected final String TEXT_90 = ".start();";
  protected final String TEXT_91 = " - The command has been executed successfully.\");";
  protected final String TEXT_92 = NL + NL + "Thread error_";
  protected final String TEXT_93 = ".getErrorStream()));" + NL + "\t\t\tString line = \"\";" + NL + "\t\t\ttry {" + NL + "\t\t\t\twhile((line = reader.readLine()) != null) {";
  protected final String TEXT_94 = " - Sending the error output to the console.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_95 = NL + "\t\t\t\t\tSystem.err.println(line);";
  protected final String TEXT_96 = " - Sending the error output to the global variable '";
  protected final String TEXT_97 = "_ERROROUTPUT'.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_98 = "_ERROROUTPUT\") != null) {" + NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_99 = "_ERROROUTPUT\", (String)globalMap.get(\"";
  protected final String TEXT_100 = "_ERROROUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_101 = "_ERROROUTPUT\", line);" + NL + "\t\t\t\t\t}";
  protected final String TEXT_102 = " - Sending the error output to both the console and the global variable '";
  protected final String TEXT_103 = "_ERROROUTPUT'.\");" + NL + "\t\t";
  protected final String TEXT_104 = NL + "        System.err.println(line);" + NL + "        " + NL + "        \tif (globalMap.get(\"";
  protected final String TEXT_105 = "_ERROROUTPUT\", line);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t" + NL + "    \t ";
  protected final String TEXT_106 = " - Sending the error output to a column of the schema.\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_107 = NL + "\t\t\tioe.printStackTrace();" + NL + "\t\t}" + NL + "\t}" + NL + "};" + NL + "error_";
  protected final String TEXT_108 = NL + "if(ps_";
  protected final String TEXT_109 = ".getOutputStream()!=null){" + NL + "    ps_";
  protected final String TEXT_110 = ".getOutputStream().close();" + NL + "}" + NL + "ps_";
  protected final String TEXT_111 = ".waitFor();" + NL + "normal_";
  protected final String TEXT_112 = ".join();" + NL + "error_";
  protected final String TEXT_113 = ".join();" + NL;
  protected final String TEXT_114 = NL + "\t\t\t\tfor(String tmp_";
  protected final String TEXT_115 = ":output_";
  protected final String TEXT_116 = "){";
  protected final String TEXT_117 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_118 = ".";
  protected final String TEXT_119 = " = tmp_";
