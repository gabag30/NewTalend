...
public class TRunJobBeginJava
{
  ...
  protected final String TEXT_19 = "();" + NL + "\t" + NL + "\tString audit_jar_path_";
  protected final String TEXT_20 = " = System.getProperty(\"classpath.extended\");" + NL + "\t";
  protected final String TEXT_21 = NL + "\t\t//For different jobs, job name must be different, but classpath and JVM arguments are possbilely different" + NL + "\t\tjava.util.Map<String,List<String>> childJob_commandLine_Mapper_";
  protected final String TEXT_22 = " = new java.util.HashMap<String,List<String>>();" + NL + "\t\tjava.util.List<String> childJob_commandLine_";
  protected final String TEXT_23 = " = null;" + NL + "\t\tString classpathSeparator_";
  protected final String TEXT_24 = " = System.getProperty(\"path.separator\");" + NL + "\t\t";
  protected final String TEXT_25 = NL + "\t\t\t\tchildJob_commandLine_";
  protected final String TEXT_26 = " = new java.util.ArrayList<String>();" + NL + "\t\t\t\t";
  protected final String TEXT_27 = NL + "\t\t\t\t\tchildJob_commandLine_";
  protected final String TEXT_28 = ".add(\"";
  protected final String TEXT_29 = "\");" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tfinal java.util.List<String> cc_";
  protected final String TEXT_30 = "_";
  protected final String TEXT_31 = " = childJob_commandLine_";
  protected final String TEXT_32 = ";" + NL + "\t\t\t\t\tif(enableLogStash){" + NL + "\t\t\t\t\t\tSystem.getProperties().stringPropertyNames().stream()" + NL + "\t\t\t\t\t\t\t.filter(it -> it.startsWith(\"audit.\"))" + NL + "\t\t\t\t\t\t\t.forEach(key -> cc_";
  protected final String TEXT_33 = ".add(\"-D\" + key + \"=\" + System.getProperty(key)));" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t" + NL + "\t\t\t\t\tSystem.getProperties().stringPropertyNames().stream()" + NL + "\t\t\t\t\t\t.filter(it -> it.startsWith(\"runtime.lineage.\") || \"classpath.extended\".equals(it))" + NL + "\t\t\t\t\t\t.forEach(key -> cc_";
  protected final String TEXT_34 = ".add(\"-D\" + key + \"=\" + System.getProperty(key)));" + NL + "\t\t\t\t\t";
  protected final String TEXT_35 = NL + "\t\t\t\t    \t\tString classpath_";
  protected final String TEXT_36 = " = ";
  protected final String TEXT_37 = ";" + NL + "\t\t\t\t    \t\t";
  protected final String TEXT_38 = NL + "\t\t\t\t    \t\tif(audit_jar_path_";
  protected final String TEXT_39 = "!=null && !audit_jar_path_";
  protected final String TEXT_40 = ".isEmpty()) {" + NL + "\t\t\t\t      \t\t\tclasspath_";
  protected final String TEXT_41 = " += audit_jar_path_";
  protected final String TEXT_42 = ";" + NL + "\t\t\t\t      \t\t}" + NL + "\t\t\t\t      \t\t";
  protected final String TEXT_43 = NL + "\t\t\t\t      \t\tjvm_argument_helper_";
  protected final String TEXT_44 = ".addArgumentsTo(childJob_commandLine_";
  protected final String TEXT_45 = ", dealChildJobLibrary_";
  protected final String TEXT_46 = ".replaceJarPathsFromCrcMap(classpath_";
  protected final String TEXT_47 = ").replaceAll(\";\",classpathSeparator_";
  protected final String TEXT_48 = "));" + NL + "\t\t\t\t    ";
  protected final String TEXT_49 = NL + "\t\t\t\t    \t\tjvm_argument_helper_";
  protected final String TEXT_50 = ", ";
  protected final String TEXT_51 = ".replaceAll(\";\",classpathSeparator_";
  ...
  protected final String TEXT_58 = NL + "\t\t\t\tchildJob_commandLine_Mapper_";
  protected final String TEXT_59 = ".put(\"";
  protected final String TEXT_60 = "\",childJob_commandLine_";
