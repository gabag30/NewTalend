...
public class TMSSqlRowEndJava
{
  ...
  protected final String TEXT_56 = NL + "        stmt_";
  protected final String TEXT_57 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_58 = " +\" OFF\");" + NL + "\t";
  protected final String TEXT_59 = NL + "\t";
  protected final String TEXT_60 = NL + "        pstmt_";
  protected final String TEXT_61 = ".close();" + NL + "        resourceMap.remove(\"pstmt_";
  protected final String TEXT_62 = "\");";
  protected final String TEXT_63 = NL + "        stmt_";
  protected final String TEXT_64 = ".close();" + NL + "        resourceMap.remove(\"stmt_";
  protected final String TEXT_65 = NL + "    resourceMap.put(\"statementClosed_";
  ...
  protected final String TEXT_70 = NL + "\t" + NL + "\t\t\tcommitCounter_";
  protected final String TEXT_71 = "=0;" + NL + "\t" + NL + "\t\t}";
  protected final String TEXT_72 = NL + "    resourceMap.put(\"finish_";
