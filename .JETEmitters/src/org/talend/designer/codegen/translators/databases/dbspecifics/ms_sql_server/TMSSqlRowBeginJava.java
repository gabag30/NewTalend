...
public class TMSSqlRowBeginJava
{
  ...
  protected final String TEXT_95 = ";" + NL + "\t\t    String dbname_";
  protected final String TEXT_96 = " ;" + NL + "\t\t    ";
  protected final String TEXT_97 = NL + "\t\t\tString url_";
  protected final String TEXT_98 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_99 = " ;" + NL + "\t\t\t";
  protected final String TEXT_100 = "\t\t    " + NL + "\t\t    String url_";
  protected final String TEXT_101 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_102 = NL + "\t\t    if (!\"\".equals(port_";
  protected final String TEXT_103 = ")) {" + NL + "\t\t    \turl_";
  protected final String TEXT_104 = " += \":\" + ";
  protected final String TEXT_105 = ";" + NL + "\t\t    }" + NL + "\t\t    if (!\"\".equals(dbname_";
  protected final String TEXT_106 = ")) {" + NL + "\t\t   \t";
  protected final String TEXT_107 = NL + "\t\t\t\turl_";
  protected final String TEXT_108 = " += \"//\" + ";
  protected final String TEXT_109 = "; " + NL + "\t\t\t";
  protected final String TEXT_110 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_111 = " += \";databaseName=\" + ";
  protected final String TEXT_112 = NL + "\t\t    }";
  protected final String TEXT_113 = NL + "                url_";
  protected final String TEXT_114 = " += \";encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;Authentication=ActiveDirectoryPassword\";" + NL + "                url_";
  protected final String TEXT_115 = " += \";database=\" + ";
  protected final String TEXT_116 = ";";
  protected final String TEXT_117 = NL + "\t\t    url_";
  protected final String TEXT_118 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_119 = ";" + NL + "\t\t";
  protected final String TEXT_120 = NL + "\t\t\t\t\tString dbschema_";
  protected final String TEXT_121 = " = (String)globalMap.get(\"";
  protected final String TEXT_122 = "\");" + NL + "\t\t\t\t";
  protected final String TEXT_123 = ";" + NL + "\t    \t\t";
  protected final String TEXT_124 = NL + "\t\t        String  tableName_";
  protected final String TEXT_125 = " = null;" + NL + "\t\t        if(dbschema_";
  protected final String TEXT_126 = " == null || dbschema_";
  protected final String TEXT_127 = ".trim().length() == 0) {" + NL + "\t\t            tableName_";
  protected final String TEXT_128 = " = \"[\" + ";
  protected final String TEXT_129 = " + \"]\";" + NL + "\t\t        } else {" + NL + "\t\t            tableName_";
  protected final String TEXT_130 = " = \"[\" + dbschema_";
  protected final String TEXT_131 = " + \"].[\" + ";
  protected final String TEXT_132 = " + \"]\";" + NL + "\t\t        }" + NL + "\t\t        stmt_";
  protected final String TEXT_133 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_134 = " +\" ON\");" + NL + "\t\t\t";
  ...
  protected final String TEXT_147 = ".createStatement();" + NL + "        resourceMap.put(\"stmt_";
