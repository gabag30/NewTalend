...
public class TMSSqlSPBeginJava
{
  ...
  protected final String TEXT_81 = " += \";encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;Authentication=ActiveDirectoryPassword\";" + NL + "        url_";
  protected final String TEXT_82 = " += \";database=\" + ";
  protected final String TEXT_83 = NL + "    url_";
  protected final String TEXT_84 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_85 = ";" + NL + "    dbUser_";
  ...
  protected final String TEXT_99 = NL + "//java.sql.Statement stmt_";
  protected final String TEXT_100 = " = conn_";
  protected final String TEXT_101 = ".createStatement();" + NL + "" + NL + "//stmt_";
  protected final String TEXT_102 = ".execute(\"SET NOCOUNT ON\");" + NL + "String spSchema_";
  protected final String TEXT_103 = " = \"\";" + NL + "if(dbschema_";
  protected final String TEXT_104 = " != null && !dbschema_";
  protected final String TEXT_105 = ".trim().isEmpty()) {" + NL + "    spSchema_";
  protected final String TEXT_106 = " = \"[\"+dbschema_";
  protected final String TEXT_107 = "+\"].\";" + NL + "}" + NL + "java.sql.CallableStatement statement_";
  protected final String TEXT_108 = ".prepareCall(\"{";
  protected final String TEXT_109 = "call \" + spSchema_";
  protected final String TEXT_110 = " + ";
  protected final String TEXT_111 = " + \"(";
  protected final String TEXT_112 = ")}\"";
  protected final String TEXT_113 = NL + "\t,java.sql.ResultSet.TYPE_SCROLL_INSENSITIVE, java.sql.ResultSet.CONCUR_READ_ONLY";
  protected final String TEXT_114 = NL + ");" + NL + "" + NL + "java.sql.Timestamp tmpDate_";
  protected final String TEXT_115 = ";" + NL + "String tmpString_";
