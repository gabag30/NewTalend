...
public class TOracleOutputMainJava {
  ...
  protected final String TEXT_174 = ".getMetaData();";
  protected final String TEXT_175 = NL + "                                    java.sql.ResultSet rsTable_";
  protected final String TEXT_176 = ".getTables(";
  protected final String TEXT_177 = ", null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_178 = ".getTables(conn_";
  protected final String TEXT_179 = ".getCatalog(), null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_180 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_181 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_182 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_183 = ".equalsIgnoreCase(";
  protected final String TEXT_184 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_185 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }";
  ...
  protected final String TEXT_207 = ") {" + NL + "\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_208 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_209 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  ...
  protected final String TEXT_245 = NL + "                            String insert_";
  protected final String TEXT_246 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_247 = " + \" (";
  protected final String TEXT_248 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_249 = ",\"";
  protected final String TEXT_250 = "+\") VALUES (";
  protected final String TEXT_251 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  ...
  protected final String TEXT_255 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_256 = " = new StringBuffer(insert_";
  protected final String TEXT_257 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_258 = ".insert(insert_";
  protected final String TEXT_259 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_260 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_261 = " =insertStringBuffer_";
  protected final String TEXT_262 = ".toString(); ";
  protected final String TEXT_263 = "    " + NL;
  protected final String TEXT_264 = NL + "                        pstmt_";
  protected final String TEXT_265 = ".prepareStatement(insert_";
  protected final String TEXT_266 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  protected final String TEXT_267 = "\", pstmt_";
  ...
  protected final String TEXT_278 = NL + "                            String update_";
  protected final String TEXT_279 = " = \"UPDATE \" + tableName_";
  protected final String TEXT_280 = " + \" SET ";
  protected final String TEXT_281 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_282 = "+\" WHERE ";
  protected final String TEXT_283 = "\";";
  protected final String TEXT_284 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_285 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_286 = " = new StringBuffer(update_";
  protected final String TEXT_287 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_288 = ".insert(update_";
  protected final String TEXT_289 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_290 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_291 = " =updateStringBuffer_";
  protected final String TEXT_292 = NL + "                    pstmt_";
  protected final String TEXT_293 = ".prepareStatement(update_";
  protected final String TEXT_294 = ");" + NL + "                    resourceMap.put(\"pstmt_";
  protected final String TEXT_295 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_296 = " + \" WHERE ";
  protected final String TEXT_297 = "\");" + NL + "                    resourceMap.put(\"pstmt_";
  protected final String TEXT_298 = "    " + NL + "                    pstmtInsert_";
  protected final String TEXT_299 = ");" + NL + "                    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_300 = "\", pstmtInsert_";
  protected final String TEXT_301 = NL + "                    pstmtUpdate_";
  protected final String TEXT_302 = ");" + NL + "                    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_303 = "\", pstmtUpdate_";
  protected final String TEXT_304 = NL + "                    String delete_";
  protected final String TEXT_305 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_306 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_307 = " = new StringBuffer(delete_";
  protected final String TEXT_308 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_309 = ".insert(delete_";
  protected final String TEXT_310 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_311 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_312 = " =deleteStringBuffer_";
  protected final String TEXT_313 = ".toString();  ";
  protected final String TEXT_314 = NL + "                    pstmt_";
  protected final String TEXT_315 = ".prepareStatement(delete_";
  protected final String TEXT_316 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_317 = " = insert_";
  protected final String TEXT_318 = ".split(\"\\\\?\");";
  protected final String TEXT_319 = NL + "\t\t\tupdate_";
  protected final String TEXT_320 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_321 = " = update_";
  protected final String TEXT_322 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_323 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_324 = NL + "\t\t\tdelete_";
  protected final String TEXT_325 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_326 = " = delete_";
  protected final String TEXT_327 = NL + "\t\t\treplace_";
  protected final String TEXT_328 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_329 = " = replace_";
  protected final String TEXT_330 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_331 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_332 = " = insertIgnore_";
  protected final String TEXT_333 = NL + "        }";
  protected final String TEXT_334 = NL + "        query_";
  protected final String TEXT_335 = " = new StringBuffer(\"\");";
  protected final String TEXT_336 = NL + "                commitEvery_";
  protected final String TEXT_337 = " = buffersSize_";
  protected final String TEXT_338 = NL + "            batchSize_";
  protected final String TEXT_339 = NL + "        whetherReject_";
  protected final String TEXT_340 = " = false;";
  protected final String TEXT_341 = NL + "                            // TODO unable to parse integer: ";
  protected final String TEXT_342 = NL + "                            // TODO error: ";
  protected final String TEXT_343 = NL + "                        org.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_344 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_345 = ";" + NL + "                        com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_346 = " = tGeometry_";
  protected final String TEXT_347 = "._getInternalGeometry();" + NL + "" + NL + "                        com.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_348 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_349 = "\");" + NL + "                        if (extends_";
  protected final String TEXT_350 = " == null) {" + NL + "                            geometryColumnToExtends.put(\"";
  protected final String TEXT_351 = "\", geometry_";
  protected final String TEXT_352 = ".getEnvelopeInternal());" + NL + "                        }" + NL + "                        else {" + NL + "                            extends_";
  protected final String TEXT_353 = ".expandToInclude(geometry_";
  protected final String TEXT_354 = ".getEnvelopeInternal());" + NL + "                        }" + NL + "" + NL + "                        String wkt_";
  protected final String TEXT_355 = " = geometry_";
  protected final String TEXT_356 = ".toText();" + NL + "                        oracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_357 = " = new oracle.spatial.util.WKT();" + NL + "                        oracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_358 = " = oracle_wkt_";
  protected final String TEXT_359 = ".toJGeometry(wkt_";
  protected final String TEXT_360 = ".getBytes());" + NL;
  protected final String TEXT_361 = NL + "                            jgeometry_";
  protected final String TEXT_362 = ".setSRID(";
  protected final String TEXT_363 = ".setObject(";
  protected final String TEXT_364 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  protected final String TEXT_365 = ", conn_";
  protected final String TEXT_366 = NL + "                        query_";
  protected final String TEXT_367 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_368 = ",";
  protected final String TEXT_369 = ", ";
  protected final String TEXT_370 = ",insertSQLSplits_";
  protected final String TEXT_371 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_372 = NL + "                globalMap.put(\"";
  protected final String TEXT_373 = "_QUERY\", query_";
  protected final String TEXT_374 = ".toString().trim());";
  protected final String TEXT_375 = NL + "                pstmt_";
  protected final String TEXT_376 = ".addBatch();" + NL + "                nb_line_";
  protected final String TEXT_377 = "++;";
  protected final String TEXT_378 = NL + "                batchSizeCounter_";
  protected final String TEXT_379 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_380 = NL + "                    insertedCount_";
  protected final String TEXT_381 = " = insertedCount_";
  protected final String TEXT_382 = " + pstmt_";
  protected final String TEXT_383 = ".executeUpdate();";
  protected final String TEXT_384 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_385 = ") {" + NL + "                    whetherReject_";
  protected final String TEXT_386 = " = true;";
  protected final String TEXT_387 = NL + "                        throw(e_";
  protected final String TEXT_388 = " = new ";
  protected final String TEXT_389 = "Struct();";
  protected final String TEXT_390 = NL + "                                ";
  protected final String TEXT_391 = NL + "                            rejectedCount_";
  protected final String TEXT_392 = " = rejectedCount_";
  protected final String TEXT_393 = " + 1;";
  protected final String TEXT_394 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_395 = ").getSQLState();";
  protected final String TEXT_396 = ".errorMessage = e_";
  protected final String TEXT_397 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_398 = NL + "                            System.err.print(e_";
  protected final String TEXT_399 = ".getMessage());";
  protected final String TEXT_400 = NL + "                }";
  protected final String TEXT_401 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_402 = ",updateSQLSplits_";
  protected final String TEXT_403 = NL + "                    int count_";
  protected final String TEXT_404 = "=DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_405 = NL + "                           ";
  protected final String TEXT_406 = NL + "                                query_";
  protected final String TEXT_407 = NL + "                            query_";
  protected final String TEXT_408 = NL + "                           query_";
  protected final String TEXT_409 = NL + "                    updatedCount_";
  protected final String TEXT_410 = " = updatedCount_";
  protected final String TEXT_411 = NL + "            int checkCount_";
  protected final String TEXT_412 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_413 = " = pstmt_";
  protected final String TEXT_414 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_415 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_416 = " = rs_";
  protected final String TEXT_417 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_418 = " > 0) {";
  protected final String TEXT_419 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_420 = NL + "                        int count_";
  protected final String TEXT_421 = ", pstmtUpdate_";
  ...
  protected final String TEXT_425 = " + pstmtUpdate_";
  protected final String TEXT_426 = ".executeUpdate();" + NL + "                    nb_line_";
  protected final String TEXT_427 = NL + "                        nb_line_";
  protected final String TEXT_428 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_429 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_430 = ", pstmtInsert_";
  protected final String TEXT_431 = " + pstmtInsert_";
  protected final String TEXT_432 = NL + "                }" + NL + "            }";
  protected final String TEXT_433 = NL + "            int updateFlag_";
  protected final String TEXT_434 = " = 0;";
  protected final String TEXT_435 = NL + NL + "                    int count_";
  protected final String TEXT_436 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_437 = " = pstmtUpdate_";
  protected final String TEXT_438 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_439 = "+updateFlag_";
  protected final String TEXT_440 = ";" + NL + "                if(updateFlag_";
  protected final String TEXT_441 = " == 0) {";
  protected final String TEXT_442 = NL + "                                routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_443 = NL + "                            DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_444 = NL + "                        globalMap.put(\"";
  protected final String TEXT_445 = NL + "                }else{" + NL + "                    nb_line_";
  ...
  protected final String TEXT_449 = NL + "                    nb_line_";
  protected final String TEXT_450 = NL + "                        rejectedCount_";
  protected final String TEXT_451 = NL + "                        System.err.print(e_";
  protected final String TEXT_452 = NL + "            }";
  protected final String TEXT_453 = NL + "                    deletedCount_";
  protected final String TEXT_454 = " = deletedCount_";
  protected final String TEXT_455 = NL + "            if(!whetherReject_";
  protected final String TEXT_456 = ") {";
  protected final String TEXT_457 = NL + "            if (batchSize_";
  protected final String TEXT_458 = " > 0 &&  batchSize_";
  protected final String TEXT_459 = " <= batchSizeCounter_";
  protected final String TEXT_460 = ") {" + NL + "                try {";
  protected final String TEXT_461 = ".executeBatch();";
  protected final String TEXT_462 = NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_463 = "){" + NL + "\t\t\t        java.sql.SQLException ne_";
  protected final String TEXT_464 = " = e_";
  protected final String TEXT_465 = ".getNextException(),sqle_";
  protected final String TEXT_466 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_467 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_468 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_469 = " = new java.sql.SQLException(e_";
  protected final String TEXT_470 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_471 = ".getMessage(), ne_";
  protected final String TEXT_472 = ".getSQLState(), ne_";
  protected final String TEXT_473 = ".getErrorCode(), ne_";
  protected final String TEXT_474 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_475 = " = sqle_";
  protected final String TEXT_476 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_477 = ".getMessage();" + NL + "\t\t\t\t\t}" + NL + "\t            \t";
  protected final String TEXT_478 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_479 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_480 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  protected final String TEXT_481 = ");" + NL + "\t\t\t            }" + NL + "\t            \t";
  protected final String TEXT_482 = NL + "\t                \tSystem.err.println(errormessage_";
  protected final String TEXT_483 = ");" + NL + "\t            \t";
  protected final String TEXT_484 = NL + "\t        \t}" + NL + "                tmp_batchUpdateCount_";
  protected final String TEXT_485 = ".getUpdateCount();";
  protected final String TEXT_486 = NL + "                += (tmp_batchUpdateCount_";
  protected final String TEXT_487 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_488 = ":0);" + NL + "                batchSizeCounter_";
  protected final String TEXT_489 = " = 0;" + NL + "            }";
  protected final String TEXT_490 = NL + "                commitCounter_";
  protected final String TEXT_491 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_492 = " <= commitCounter_";
  protected final String TEXT_493 = ") {" + NL;
  protected final String TEXT_494 = NL + "                        try {";
  protected final String TEXT_495 = NL + "                            pstmt_";
  protected final String TEXT_496 = NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_497 = "){" + NL + "\t\t\t\t\t        java.sql.SQLException ne_";
  ...
  protected final String TEXT_502 = ".getMessage();" + NL + "\t\t\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t\t\terrormessage_";
  protected final String TEXT_503 = ".getMessage();" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t            \t";
  protected final String TEXT_504 = NL + "\t\t\t\t\t    \t\tif (ne_";
  protected final String TEXT_505 = " != null) {" + NL + "\t\t\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_506 = ");" + NL + "\t\t\t\t\t    \t\t}else{" + NL + "\t\t\t\t\t            \tthrow(e_";
  protected final String TEXT_507 = ");" + NL + "\t\t\t\t\t            }" + NL + "\t\t\t            \t";
  protected final String TEXT_508 = NL + "\t\t\t                \tSystem.err.println(errormessage_";
  protected final String TEXT_509 = ");" + NL + "\t\t\t            \t";
  protected final String TEXT_510 = NL + "\t\t\t        \t}" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_511 = NL + "                            insertedCount_";
  protected final String TEXT_512 = NL + "                            updatedCount_";
  protected final String TEXT_513 = NL + "                            deletedCount_";
  protected final String TEXT_514 = NL + "                        += (tmp_batchUpdateCount_";
  protected final String TEXT_515 = ":0);";
  protected final String TEXT_516 = NL + "                    conn_";
  protected final String TEXT_517 = NL + "                    commitCounter_";
  protected final String TEXT_518 = "=0;" + NL + "                }";
