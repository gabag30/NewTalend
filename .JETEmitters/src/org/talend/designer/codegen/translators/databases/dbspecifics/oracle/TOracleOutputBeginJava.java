...
public class TOracleOutputBeginJava {
  ...
  protected final String TEXT_311 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_312 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_313 = NL + "                              stmtTruncCount_";
  protected final String TEXT_314 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_315 = " = stmtTruncCount_";
  protected final String TEXT_316 = ".executeQuery(\"";
  protected final String TEXT_317 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_318 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_319 = " = rsTruncCount_";
  protected final String TEXT_320 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_321 = NL + "                              stmtTrunc_";
  protected final String TEXT_322 = NL + "                conn_";
  protected final String TEXT_323 = NL + "                stmtTrunc_";
  protected final String TEXT_324 = NL + "                    if(!conn_";
  protected final String TEXT_325 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_326 = ".commit();" + NL + "                    }";
  protected final String TEXT_327 = NL + "                deletedCount_";
  protected final String TEXT_328 = " += rsTruncCountNumber_";
  protected final String TEXT_329 = ";" + NL + "            }";
  protected final String TEXT_330 = NL + "            try (java.sql.Statement stmtTruncCount_";
  protected final String TEXT_331 = ".createStatement();" + NL + "                java.sql.ResultSet rsTruncCount_";
  ...
  protected final String TEXT_336 = ".getInt(1);" + NL + "                }" + NL + "            }";
  ...
  protected final String TEXT_353 = ");" + NL + "                        resourceMap.put(\"pstmt_";
  protected final String TEXT_354 = "\", pstmt_";
  protected final String TEXT_355 = " = null;" + NL + "                        // [%connection%][psmt][tableName]" + NL + "                        String keyPsmt_";
  protected final String TEXT_356 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_357 = " + \"]\";" + NL + "                        pstmt_";
  protected final String TEXT_358 = " = SharedDBPreparedStatement.getSharedPreparedStatement(conn_";
  protected final String TEXT_359 = ",insert_";
  protected final String TEXT_360 = ",keyPsmt_";
  ...
  protected final String TEXT_364 = " WHERE ";
  protected final String TEXT_365 = "\";";
  protected final String TEXT_366 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_367 = " = new StringBuffer(update_";
  protected final String TEXT_368 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_369 = ".insert(update_";
  protected final String TEXT_370 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_371 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_372 = " =updateStringBuffer_";
  ...
  protected final String TEXT_375 = ");" + NL + "                resourceMap.put(\"pstmt_";
  protected final String TEXT_376 = ".prepareStatement(\"SELECT COUNT(1) FROM \" + tableName_";
  protected final String TEXT_377 = " + \" WHERE ";
  protected final String TEXT_378 = "\");" + NL + "                resourceMap.put(\"pstmt_";
  protected final String TEXT_379 = ");" + NL + "                String insert_";
  protected final String TEXT_380 = "    " + NL + "                java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_381 = ");" + NL + "                resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_382 = "\", pstmtInsert_";
  protected final String TEXT_383 = ");" + NL + "                String update_";
  protected final String TEXT_384 = NL + "                java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_385 = ");" + NL + "                resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_386 = "\", pstmtUpdate_";
  protected final String TEXT_387 = NL + "                String delete_";
  protected final String TEXT_388 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_389 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_390 = " = new StringBuffer(delete_";
  protected final String TEXT_391 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_392 = ".insert(delete_";
  protected final String TEXT_393 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_394 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_395 = " =deleteStringBuffer_";
  protected final String TEXT_396 = ".toString();  ";
  protected final String TEXT_397 = NL + "                java.sql.PreparedStatement pstmt_";
  protected final String TEXT_398 = ".prepareStatement(delete_";
  protected final String TEXT_399 = NL + "                StringBuffer query_";
  protected final String TEXT_400 = NL + "\t\t \tString[] insertSQLSplits_";
  protected final String TEXT_401 = " = insert_";
  protected final String TEXT_402 = ".split(\"\\\\?\");";
  protected final String TEXT_403 = NL + "\t\t\tupdate_";
  protected final String TEXT_404 = " += \" \";" + NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_405 = " = update_";
  protected final String TEXT_406 = " += \" \";" + NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_407 = ".split(\"\\\\?\");" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_408 = NL + "\t\t\tdelete_";
  protected final String TEXT_409 = " += \" \";" + NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_410 = " = delete_";
  protected final String TEXT_411 = NL + "\t\t\treplace_";
  protected final String TEXT_412 = " += \" \";" + NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_413 = " = replace_";
  protected final String TEXT_414 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_415 = " += \" \";" + NL + "\t\t\tString[] insertIgnoreSQLSplits_";
  protected final String TEXT_416 = " = insertIgnore_";
  protected final String TEXT_417 = NL + "                // Initialize SRID" + NL + "                int SRID_";
  protected final String TEXT_418 = " = 0;" + NL + "                int dimension_";
  protected final String TEXT_419 = " = 0;" + NL + "                boolean firstGeometry_";
  protected final String TEXT_420 = " = true;";
  protected final String TEXT_421 = NL + NL + "        class ClobTypeUtil_";
  protected final String TEXT_422 = " {" + NL + "            public Object getCLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException{" + NL + "                oracle.sql.CLOB tempClob = null;" + NL + "                try{" + NL + "                    // If the temporary CLOB has not yet been created, create one" + NL + "                    tempClob = oracle.sql.CLOB.createTemporary(conn, true, oracle.sql.CLOB.DURATION_SESSION);" + NL + "                    // Open the temporary CLOB in readwrite mode, to enable writing" + NL + "                    tempClob.open(oracle.sql.CLOB.MODE_READWRITE);" + NL + "                    // Get the output stream to write" + NL + "                    java.io.Writer tempClobWriter = tempClob.getCharacterOutputStream();" + NL + "                    if(data instanceof java.sql.Clob) {" + NL + "                        java.sql.Clob inClob = (java.sql.Clob) data;" + NL + "                        java.io.Reader inReader = inClob.getCharacterStream();" + NL + "                        char[] chs = new char[128];" + NL + "                        int len = 0;" + NL + "                        while ((len = inReader.read(chs)) != -1) {" + NL + "                            tempClobWriter.write(chs, 0, len);" + NL + "                        }" + NL + "                    }else if(data instanceof String) {" + NL + "                       // Write the data into the temporary CLOB" + NL + "                        tempClobWriter.write((String)data);" + NL + "                    }else{" + NL + "                        return data;" + NL + "                    }" + NL + "                    // Flush and close the stream" + NL + "                    tempClobWriter.flush();" + NL + "                    tempClobWriter.close();" + NL + "                    // Close the temporary CLOB" + NL + "                    tempClob.close();" + NL + "                } catch( java.sql.SQLException sqlexp){";
  protected final String TEXT_423 = NL + "                    tempClob.freeTemporary();" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_424 = NL + "                    tempClob.freeTemporary();" + NL + "                    exp.printStackTrace();" + NL + "                }" + NL + "                return tempClob;" + NL + "            }" + NL + "        }" + NL + "        ClobTypeUtil_";
  protected final String TEXT_425 = " clobTypeUtil_";
  protected final String TEXT_426 = "=new ClobTypeUtil_";
  protected final String TEXT_427 = "();";
  protected final String TEXT_428 = NL + NL + "        class BlobTypeUtil_";
  protected final String TEXT_429 = " {" + NL + "            public Object getBLOB(Object data, java.sql.Connection conn) throws java.sql.SQLException {" + NL + "                if(!(data instanceof java.sql.Blob) || (data instanceof oracle.sql.BLOB)) {" + NL + "                \treturn data;" + NL + "                }" + NL + "" + NL + "                oracle.sql.BLOB blob = null;" + NL + "                java.io.InputStream in = null;" + NL + "                java.io.OutputStream out = null;" + NL + "                try{" + NL + "                \t//in" + NL + "                \tjava.sql.Blob blobData = (java.sql.Blob) data;" + NL + "                \tin = blobData.getBinaryStream();" + NL + "" + NL + "                \t//out" + NL + "                \tblob = oracle.sql.BLOB.createTemporary(conn, true, oracle.sql.BLOB.DURATION_SESSION);" + NL + "                    blob.open(oracle.sql.BLOB.MODE_READWRITE);" + NL + "                    //blob = conn.createBlob(); oracle jdbc don't support it" + NL + "                \tout = blob.setBinaryStream(1);" + NL + "" + NL + "                    byte[] cache = new byte[8192];" + NL + "                    int len = 0;" + NL + "                    while ((len = in.read(cache)) != -1) {" + NL + "                        out.write(cache, 0, len);" + NL + "                    }" + NL + "" + NL + "                    return blob;" + NL + "                } catch(java.sql.SQLException sqlexp){";
  protected final String TEXT_430 = NL + "                \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_431 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    sqlexp.printStackTrace();" + NL + "                } catch(java.lang.Exception exp){";
  protected final String TEXT_432 = NL + "                   \tif(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.freeTemporary();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_433 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                    exp.printStackTrace();" + NL + "                } finally {" + NL + "                \tif(out!=null) {" + NL + "                \t\ttry {" + NL + "                \t\t\tout.flush();" + NL + "                    \t\tout.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_434 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "            \t \tif(in!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tin.close();" + NL + "                    \t} catch(java.io.IOException e_";
  protected final String TEXT_435 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "" + NL + "                    if(blob!=null) {" + NL + "                \t\ttry {" + NL + "                    \t\tblob.close();" + NL + "                    \t} catch(java.sql.SQLException e_";
  protected final String TEXT_436 = ") {" + NL + "                    \t\t//keep quiet" + NL + "                    \t}" + NL + "                    }" + NL + "                }" + NL + "" + NL + "                return null;" + NL + "" + NL + "            }" + NL + "" + NL + "        }" + NL + "        BlobTypeUtil_";
  protected final String TEXT_437 = " blobTypeUtil_";
  protected final String TEXT_438 = "=new BlobTypeUtil_";
  protected final String TEXT_439 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_440 = " =null;" + NL + "        java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_441 = " =null;" + NL + "        java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_442 = " =null;";
  protected final String TEXT_443 = NL + "            StringBuffer query_";
  protected final String TEXT_444 = NL + "\t    \tString[] updateSQLSplits_";
  protected final String TEXT_445 = " =  null;";
  protected final String TEXT_446 = NL + "\t\t\tString[] updateSQLSplits_";
  protected final String TEXT_447 = " = null;" + NL + "\t\t\tString[] insertSQLSplits_";
  protected final String TEXT_448 = NL + "\t\t   \tString[] deleteSQLSplits_";
  protected final String TEXT_449 = NL + "\t\t\tString[] replaceSQLSplits_";
  protected final String TEXT_450 = NL + "\t\t\tString[] insertIgnoreSQLSplits_";
