...
public class TOracleConnectionBeginJava
{
  ...
  protected final String TEXT_132 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_133 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_134 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_135 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_136 = " - Uses an existing connection ";
  protected final String TEXT_137 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_138 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_139 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_140 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_141 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  ...
  protected final String TEXT_146 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_147 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_148 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_149 = NL + "\t\t\tif(\"com.mysql.cj.jdbc.Driver\".equals((String)globalMap.get(\"driverClass_";
  protected final String TEXT_150 = "\"))" + NL + "\t\t\t    && routines.system.BundleUtils.inOSGi()) {" + NL + "\t\t\t        Class.forName(\"com.mysql.cj.jdbc.AbandonedConnectionCleanupThread\")." + NL + "\t\t\t            getMethod(\"checkedShutdown\").invoke(null, (Object[]) null);" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_151 = NL + "\t\t\t\tconn_";
  protected final String TEXT_152 = NL + "\t\t\t\tlog.";
  protected final String TEXT_153 = "(\"";
  protected final String TEXT_154 = " - \" + ";
  protected final String TEXT_155 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_156 = NL + "\t    \t\tlog.";
  protected final String TEXT_157 = "\");" + NL + "\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_159 = ".executeBatch();" + NL + "\t\t\t";
  ...
  protected final String TEXT_163 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_164 = " += (countEach_";
  protected final String TEXT_165 = " < 0 ? 0 : ";
  protected final String TEXT_166 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_167 = NL + "\t";
  protected final String TEXT_168 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_169 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  protected final String TEXT_170 = " == null) {";
  protected final String TEXT_171 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_172 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_173 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_174 = ".get(dsAlias_";
  protected final String TEXT_175 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_176 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_177 = " = dataSources_";
  protected final String TEXT_178 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_179 = ");" + NL + "\t}";
  protected final String TEXT_180 = NL + "\tif (null != conn_";
  protected final String TEXT_181 = ") {" + NL + "\t\t";
  protected final String TEXT_182 = NL + "\t}";
  protected final String TEXT_183 = NL;
  protected final String TEXT_184 = NL + "  \tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_185 = "\",conn_";
  protected final String TEXT_186 = ".getMetaData().getUserName());";
  protected final String TEXT_187 = NL + "\tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_188 = NL + "\tglobalMap.put(\"username_\" + \"";
  protected final String TEXT_189 = ");" + NL + "\tglobalMap.put(\"password_\" + \"";
  protected final String TEXT_190 = "\",dbPwd_";
