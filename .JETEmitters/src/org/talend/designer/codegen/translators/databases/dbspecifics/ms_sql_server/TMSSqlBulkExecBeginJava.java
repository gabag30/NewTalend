...
public class TMSSqlBulkExecBeginJava {
  ...
  protected final String TEXT_35 = NL + "int deletedCount_";
  ...
  protected final String TEXT_53 = NL + "\t\t\t\tif(conn_";
  protected final String TEXT_54 = " != null) {" + NL + "\t\t\t\t\tif(conn_";
  protected final String TEXT_55 = ".getMetaData() != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_56 = NL + "\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_57 = " - Uses an existing connection ";
  protected final String TEXT_58 = ".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_59 = NL + "\t\t\t\t\t\t\tlog.debug(\"";
  protected final String TEXT_60 = " - Uses an existing connection with username '\" + conn_";
  protected final String TEXT_61 = ".getMetaData().getUserName() + \"'. Connection URL: \" + conn_";
  protected final String TEXT_62 = ".getMetaData().getURL() + \".\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_63 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_64 = NL + "\t\t\tconn_";
  protected final String TEXT_65 = " = java.sql.DriverManager.getConnection(url_";
  protected final String TEXT_66 = ", dbUser_";
  protected final String TEXT_67 = ", dbPwd_";
  protected final String TEXT_68 = ");" + NL + "\t\t\t";
  protected final String TEXT_69 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_70 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_71 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_72 = NL + "\t\t\tif(\"com.mysql.cj.jdbc.Driver\".equals((String)globalMap.get(\"driverClass_";
  protected final String TEXT_73 = "\"))" + NL + "\t\t\t    && routines.system.BundleUtils.inOSGi()) {" + NL + "\t\t\t        Class.forName(\"com.mysql.cj.jdbc.AbandonedConnectionCleanupThread\")." + NL + "\t\t\t            getMethod(\"checkedShutdown\").invoke(null, (Object[]) null);" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_74 = NL + "\t\t\t\tconn_";
  protected final String TEXT_75 = ".setAutoCommit(";
  protected final String TEXT_76 = NL + "\t\t\t\tlog.";
  protected final String TEXT_77 = " - \" + ";
  protected final String TEXT_78 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_79 = NL + "\t    \t\tlog.";
  protected final String TEXT_80 = "\");" + NL + "\t\t\t";
  protected final String TEXT_81 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_82 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_83 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_84 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_85 = ": pstmt_";
  protected final String TEXT_86 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_87 = " += (countEach_";
  protected final String TEXT_88 = " < 0 ? 0 : ";
  ...
  protected final String TEXT_97 = NL + "\tStringBuffer command_";
  protected final String TEXT_98 = " = new StringBuffer();" + NL + "\tcommand_";
  protected final String TEXT_99 = ")" + NL + "\t\t.append(\" \\\"\")" + NL + "\t\t.append(";
  protected final String TEXT_100 = ")" + NL + "\t\t.append(\"\\\" queryout \\\"\")" + NL + "\t\t.append(";
  protected final String TEXT_101 = ")" + NL + "\t\t.append(\"\\\" \")" + NL + "\t\t.append(\"";
  protected final String TEXT_102 = "\")" + NL + "\t";
  protected final String TEXT_103 = NL + "\t\t.append(\" -S\")" + NL + "\t\t.append(";
  protected final String TEXT_104 = ")" + NL + "\t";
  protected final String TEXT_105 = NL + "\t\t.append(\" -T\")" + NL + "\t";
  protected final String TEXT_106 = NL + "\t\t.append(\" -U\")" + NL + "\t\t.append(";
  protected final String TEXT_107 = ")" + NL + "\t\t.append(\" -P\")" + NL + "\t\t.append(decryptedPassword_";
  protected final String TEXT_108 = NL + "\t\t.append(\" -t\")" + NL + "\t\t.append(";
  protected final String TEXT_109 = ")" + NL + "\t\t.append(\" -r\")" + NL + "\t\t.append(";
  protected final String TEXT_110 = ");" + NL + "" + NL + "\tRuntime runtime_";
  protected final String TEXT_111 = " = Runtime.getRuntime();" + NL + "\t";
  protected final String TEXT_112 = NL + "\tfinal Process ps";
  protected final String TEXT_113 = " = runtime_";
  protected final String TEXT_114 = ".exec(command_";
  protected final String TEXT_115 = ".toString());" + NL + "\tThread normal_";
  protected final String TEXT_116 = " = new Thread() {" + NL + "\t\tpublic void run() {" + NL + "\t\t\ttry {" + NL + "\t\t\t\tjava.io.BufferedReader reader = new java.io.BufferedReader(new java.io.InputStreamReader(ps";
  protected final String TEXT_117 = ".getInputStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_118 = NL + "\t\t\t\t\t\t\tSystem.out.println(line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_119 = NL + "\t\t\t\t\t\t\tglobalMap.put(\"";
  protected final String TEXT_120 = "_OUTPUT\",(String)globalMap.get(\"";
  protected final String TEXT_121 = "_OUTPUT\")+\"\\n\"+line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\t\t}" + NL + "\t\t\t\t} finally {" + NL + "\t\t\t\t\treader.close();" + NL + "\t\t\t\t}" + NL + "\t\t\t} catch(java.io.IOException ioe) {" + NL + "\t\t\t\t";
  protected final String TEXT_123 = NL + "\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\tnormal_";
  protected final String TEXT_124 = ".start();" + NL + "\tThread error_";
  protected final String TEXT_125 = ".getErrorStream()));" + NL + "\t\t\t\tString line = \"\";" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\twhile((line = reader.readLine()) != null) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_126 = NL + "\t\t\t\t\t\t\tSystem.err.println(line);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_127 = NL + "\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t};" + NL + "\terror_";
  protected final String TEXT_128 = ".start();" + NL + "\tps";
  protected final String TEXT_129 = ".waitFor();" + NL + "\tnormal_";
  protected final String TEXT_130 = ".interrupt();" + NL + "\terror_";
  protected final String TEXT_131 = ".interrupt();" + NL + "\t";
  protected final String TEXT_132 = NL + "\tString dbschema_";
  ...
  protected final String TEXT_137 = NL + "\tdbschema_";
  protected final String TEXT_138 = ";" + NL + "\t";
  protected final String TEXT_139 = " = (String)globalMap.get(\"";
  protected final String TEXT_140 = "\");" + NL + "\t";
  protected final String TEXT_141 = NL + "\tconn_";
  protected final String TEXT_142 = " = (java.sql.Connection)globalMap.get(\"";
  protected final String TEXT_143 = NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_144 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\t\tif (null != dataSources_";
  protected final String TEXT_145 = ") {" + NL + "\t\t\tString dsAlias_";
  ...
  protected final String TEXT_151 = ").getConnection();" + NL + "\t\t} else {" + NL + "\t";
  protected final String TEXT_152 = NL + "    dbschema_";
  protected final String TEXT_153 = ";";
  protected final String TEXT_154 = NL + "    String driverClass_";
  protected final String TEXT_155 = " = \"net.sourceforge.jtds.jdbc.Driver\";";
  protected final String TEXT_156 = " = \"com.microsoft.sqlserver.jdbc.SQLServerDriver\";";
  protected final String TEXT_157 = NL + "\t";
  protected final String TEXT_158 = NL + "    java.lang.Class.forName(driverClass_";
  protected final String TEXT_159 = ");" + NL + "    String port_";
  protected final String TEXT_160 = ";" + NL + "    String dbname_";
  protected final String TEXT_161 = " ;";
  protected final String TEXT_162 = NL + "    String url_";
  protected final String TEXT_163 = " = \"jdbc:jtds:sqlserver://\" + ";
  protected final String TEXT_164 = " = \"jdbc:sqlserver://\" + ";
  protected final String TEXT_165 = " " + NL + "    if (!\"\".equals(port_";
  protected final String TEXT_166 = ")) {" + NL + "    \turl_";
  protected final String TEXT_167 = " += \":\" + ";
  protected final String TEXT_168 = ";" + NL + "    }" + NL + "    if (!\"\".equals(dbname_";
  protected final String TEXT_169 = ")) {";
  protected final String TEXT_170 = NL + "\t\t\t\turl_";
  protected final String TEXT_171 = " += \"//\" + ";
  protected final String TEXT_172 = "; " + NL + "\t";
  protected final String TEXT_173 = "\t\t    " + NL + "\t\t    \turl_";
  protected final String TEXT_174 = " += \";databaseName=\" + ";
  protected final String TEXT_175 = NL + "    }";
  protected final String TEXT_176 = NL + "        url_";
  protected final String TEXT_177 = " += \";encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;Authentication=ActiveDirectoryPassword\";" + NL + "        url_";
  protected final String TEXT_178 = " += \";database=\" + ";
  protected final String TEXT_179 = NL + "    url_";
  protected final String TEXT_180 = " += \";appName=\" + projectName + \";\" + ";
  protected final String TEXT_181 = ";" + NL + "    dbUser_";
  protected final String TEXT_182 = ";" + NL;
  protected final String TEXT_183 = NL;
  protected final String TEXT_184 = NL + NL + "    String dbPwd_";
  protected final String TEXT_185 = " = decryptedPassword_";
  protected final String TEXT_186 = "\t" + NL + "    conn_";
  protected final String TEXT_187 = ",dbUser_";
  ...
  protected final String TEXT_191 = " = null;" + NL + "\tif(dbschema_";
  protected final String TEXT_192 = " == null || dbschema_";
  protected final String TEXT_193 = ".trim().length() == 0) {" + NL + "\t\ttableName_";
  protected final String TEXT_194 = ";" + NL + "\t} else {" + NL + "\t\ttableName_";
  ...
  protected final String TEXT_203 = " - Droping table ";
  protected final String TEXT_204 = "\" + tableName_";
  protected final String TEXT_205 = " + \"";
  protected final String TEXT_206 = ".\");" + NL + "\t\t\t";
  protected final String TEXT_207 = NL + "\t\t\tstmtDrop_";
  protected final String TEXT_208 = ".execute(\"";
  protected final String TEXT_209 = "\");" + NL + "\t\t\t";
  protected final String TEXT_210 = " - Drop table ";
  protected final String TEXT_211 = " has succeeded.\");" + NL + "\t\t\t";
  protected final String TEXT_212 = ".close();" + NL + "\t\t\tjava.sql.Statement stmtCreate_";
  protected final String TEXT_213 = " - Creating table ";
  protected final String TEXT_214 = NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_215 = NL + "\t\t\t\t";
  protected final String TEXT_216 = NL + "routines.system.Dynamic dynamicColumn = (Dynamic)globalMap.get(\"";
  protected final String TEXT_217 = "\" + \"_DYNAMIC\");" + NL + "boolean guessSchemaFromFile = (Boolean)globalMap.get(\"";
  protected final String TEXT_218 = "\" + \"_DYNAMIC_GSFF\");" + NL + "" + NL + "//We should do nothing when tSetDynamicSchema doesn't guess schema from file" + NL + "//If guessSchemaFromFile = true we can modify columns metadata" + NL + "if (guessSchemaFromFile){" + NL + "\t";
  protected final String TEXT_219 = NL + "\t\tfor (DynamicMetadata column : dynamicColumn.metadatas){" + NL + "\t\t\t";
  protected final String TEXT_220 = NL + "\t\t\tif (column.getType().equals(\"id_Double\")){" + NL + "\t\t\t\tcolumn.setLength(";
  protected final String TEXT_221 = ");" + NL + "\t\t\t} else if (column.getType().equals(\"id_String\")){" + NL + "\t\t\t\tcolumn.setLength(";
  protected final String TEXT_222 = ");" + NL + "\t\t\t} else if (column.getType().equals(\"id_Boolean\")){" + NL + "\t\t\t\tcolumn.setType(\"id_String\");" + NL + "\t\t\t\tcolumn.setLength(5);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_223 = NL + "\t\t\tif (column.getType().equals(\"id_String\")){" + NL + "\t\t\t\tcolumn.setLength(";
  protected final String TEXT_224 = ");" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_225 = NL + "}" + NL + "String columnsPart = DynamicUtils.getCreateTableSQL(dynamicColumn, \"";
  protected final String TEXT_226 = "\");" + NL + "" + NL + "//Escape table name" + NL + "String queryForExec = \"\";";
  protected final String TEXT_227 = NL + "\tqueryForExec = \"CREATE TABLE \" + \"[\" + tableName_";
  protected final String TEXT_228 = " + \"] (\" + columnsPart + \")\";";
  protected final String TEXT_229 = NL + "\tqueryForExec = \"CREATE TABLE \" + tableName_";
  protected final String TEXT_230 = " + \" (\" + columnsPart + \")\";";
  protected final String TEXT_231 = NL + "\tlog.debug(\"";
  protected final String TEXT_232 = " - Creating table with query: \" + queryForExec);";
  protected final String TEXT_233 = NL + "stmtCreate_";
  protected final String TEXT_234 = ".execute(queryForExec);" + NL + "\t\t\t";
  protected final String TEXT_235 = NL + "\t\t\t\tstmtCreate_";
  protected final String TEXT_236 = ")\");" + NL + "\t\t\t";
  protected final String TEXT_237 = " - Create table ";
  ...
  protected final String TEXT_242 = ".getMetaData();" + NL + "\t\t\t\tif(tableNameForSearch_";
  protected final String TEXT_243 = ".indexOf(\"\\\"\")==-1){" + NL + "\t\t\t\t\ttableNameForSearch_";
  protected final String TEXT_244 = " = tableNameForSearch_";
  protected final String TEXT_245 = ".toUpperCase();" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttableNameForSearch_";
  ...
  protected final String TEXT_262 = ".equalsIgnoreCase(";
  protected final String TEXT_263 = ")" + NL + "\t\t\t\t\t\t&& (schema_";
  protected final String TEXT_264 = ".equalsIgnoreCase(dbschema_";
  ...
  protected final String TEXT_268 = ".getString(\"TABLE_NAME\");" + NL + "\t\t\t\t\tString bkSchema_";
  ...
  protected final String TEXT_278 = ".trim().length() == 0) {" + NL + "\t\t\t\t\tjava.sql.Statement stmtSchema_";
  ...
  protected final String TEXT_292 = " ==null || dbschema_";
  protected final String TEXT_293 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_294 = "(schema_";
  protected final String TEXT_295 = NL + "            \tString tableForSearch_";
  protected final String TEXT_296 = ";" + NL + "            \tif(tableForSearch_";
  protected final String TEXT_297 = " != null){" + NL + "            \t\tif(tableForSearch_";
  protected final String TEXT_298 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_299 = ".endsWith(\"\\\"\")){" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_300 = " =  tableForSearch_";
  protected final String TEXT_301 = ".substring(1,tableForSearch_";
  protected final String TEXT_302 = ".length()-1);" + NL + "            \t\t}else{" + NL + "            \t\t\ttableForSearch_";
  protected final String TEXT_303 = ".toUpperCase();" + NL + "            \t\t}" + NL + "            \t}" + NL + "                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_304 = ".getMetaData();" + NL + "                java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_309 = " = true;" + NL + "\t\t\t\t}" + NL + "                rsTable_";
  protected final String TEXT_310 = ".getTables(null, dbschema_";
  protected final String TEXT_311 = ", null, new String[]{\"TABLE\"});" + NL + "                boolean whetherExist_";
  protected final String TEXT_312 = " = false;" + NL + "                while(rsTable_";
  protected final String TEXT_313 = ".next()) {" + NL + "                    if(rsTable_";
  protected final String TEXT_314 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(";
  ...
  protected final String TEXT_319 = ".getMetaData();";
  protected final String TEXT_320 = NL + "                    java.sql.ResultSet rsTable_";
  protected final String TEXT_321 = ".getTables(";
  protected final String TEXT_322 = ", null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_323 = ".getTables(conn_";
  protected final String TEXT_324 = ".getCatalog(), null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_325 = NL + "                boolean whetherExist_";
  ...
  protected final String TEXT_337 = ".execute(queryForExec);" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_342 = ".close();" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_343 = NL + "\t\t\t\tif(whetherExist_";
  protected final String TEXT_344 = ") {" + NL + "\t\t\t\t\tjava.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_351 = ".execute(queryForExec);" + NL + "\t\t\t\t";
  protected final String TEXT_352 = ")\");" + NL + "\t\t\t\t";
  protected final String TEXT_353 = " has succeeded.\");" + NL + "\t\t\t\t";
  protected final String TEXT_354 = NL + "\t\t\tjava.sql.Statement stmtClear_";
  protected final String TEXT_355 = " - Clearing table ";
  protected final String TEXT_356 = NL + "\t\t\tstmtClear_";
  protected final String TEXT_357 = ".executeUpdate(\"";
  protected final String TEXT_358 = "- Clear table ";
  protected final String TEXT_359 = NL + "\t\t\tjava.sql.Statement stmtTruncCount_";
  protected final String TEXT_360 = ".createStatement();" + NL + "\t\t\tjava.sql.ResultSet rsTruncCount_";
  protected final String TEXT_361 = " = stmtTruncCount_";
  protected final String TEXT_362 = ".executeQuery(\"";
  protected final String TEXT_363 = "\");" + NL + "\t\t\tjava.sql.Statement stmtTrunc_";
  protected final String TEXT_364 = " - Trancating table ";
  protected final String TEXT_365 = NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_366 = "\");" + NL + "   \t    \t";
  protected final String TEXT_367 = " - Truncate table ";
  protected final String TEXT_368 = NL + "\t\t\twhile(rsTruncCount_";
  protected final String TEXT_369 = ".next()) {" + NL + "\t\t\t\tdeletedCount_";
  protected final String TEXT_370 = " += rsTruncCount_";
  protected final String TEXT_371 = ".getInt(1);" + NL + "\t\t\t}" + NL + "\t\t\trsTruncCount_";
  protected final String TEXT_372 = ".close();" + NL + "\t\t\tstmtTruncCount_";
  protected final String TEXT_373 = ".close();" + NL + "\t\t\tstmtTrunc_";
  protected final String TEXT_374 = NL + "\t\t//in mysql when autoCommit=true don't commit." + NL + "\t\tif (! conn_";
  protected final String TEXT_375 = ".getAutoCommit()) {" + NL + "\t\t\tconn_";
  protected final String TEXT_376 = ".commit();" + NL + "\t\t}" + NL + "\t";
  protected final String TEXT_377 = NL + "    \t";
  protected final String TEXT_378 = NL + "    \t\tjava.sql.Statement stmtBulkInsert_";
  protected final String TEXT_379 = ".createStatement();" + NL + "    \t\tString bulkSQL_";
  protected final String TEXT_380 = " = \"BULK INSERT ";
  protected final String TEXT_381 = " FROM '\" + ";
  protected final String TEXT_382 = NL + "    \t\t    + \"' WITH ( ";
  protected final String TEXT_383 = " CODEPAGE='\" + ";
  protected final String TEXT_384 = " + \"',\t";
  protected final String TEXT_385 = " DATAFILETYPE='";
  protected final String TEXT_386 = "',FIELDTERMINATOR='\" + ";
  protected final String TEXT_387 = " + \"',FIRSTROW =\" + ";
  protected final String TEXT_388 = NL + "    \t\t    + ";
  protected final String TEXT_389 = "\",FIRE_TRIGGERS\" + ";
  protected final String TEXT_390 = " \",ROWTERMINATOR='\" + ";
  protected final String TEXT_391 = "+\"'\"" + NL + "    \t\t    + (";
  protected final String TEXT_392 = ".isEmpty() ? \"\" : \",\" + ";
  protected final String TEXT_393 = ") + \")\";" + NL + "    \t\t";
  protected final String TEXT_394 = NL + "    \t\t\tlog.debug(\"";
  protected final String TEXT_395 = " - Bulk SQL:\"+bulkSQL_";
  protected final String TEXT_396 = "+\".\");" + NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_397 = " - Bulk inserting data into ";
  protected final String TEXT_398 = ".\" );" + NL + "    \t\t";
  protected final String TEXT_399 = NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_400 = ".execute(bulkSQL_";
  protected final String TEXT_401 = ");" + NL + "    \t\tstmtBulkInsert_";
  protected final String TEXT_402 = ".close();" + NL + "    \t\t";
  protected final String TEXT_403 = NL + "    \t\t\tlog.info(\"";
  protected final String TEXT_404 = " - Bulk insert data into ";
  protected final String TEXT_405 = " has finished.\");" + NL + "    \t\t";
  protected final String TEXT_406 = NL + "    \t\t\tint keyCount_";
  protected final String TEXT_407 = ";" + NL + "    \t\t\tif(keyCount_";
  protected final String TEXT_408 = " == 0) {" + NL + "    \t\t\t\tthrow new RuntimeException(\"For bulk update, Schema must have a key at least.\");" + NL + "    \t\t\t}" + NL + "    \t\t\tString tmpTableName_";
  protected final String TEXT_409 = " = tableName_";
  protected final String TEXT_410 = ";" + NL + "    \t\t\ttableName_";
  protected final String TEXT_411 = " = \"tmp_";
  protected final String TEXT_412 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtCreateTmp_";
  protected final String TEXT_413 = ".createStatement();" + NL + "    \t\t\t";
  protected final String TEXT_414 = NL + "    \t\t\t\tlog.info(\"";
  protected final String TEXT_415 = " - Creating temp table ";
  protected final String TEXT_416 = ".\" );" + NL + "    \t\t\t";
  protected final String TEXT_417 = NL + "    \t\t\tstmtCreateTmp_";
  protected final String TEXT_418 = ")\");" + NL + "    \t\t\t";
  protected final String TEXT_419 = " - Create temp table ";
  protected final String TEXT_420 = " has succeeded.\");" + NL + "    \t\t\t";
  protected final String TEXT_421 = ".close();" + NL + "    \t\t\tjava.sql.Statement stmtTmpBulk_";
  protected final String TEXT_422 = ".createStatement();" + NL + "    \t\t\tString bulkSQL_";
  protected final String TEXT_423 = NL + "    \t\t\t    + \"' WITH ( ";
  protected final String TEXT_424 = NL + "    \t\t\t    + \",ROWTERMINATOR='\" + ";
  ...
  protected final String TEXT_429 = NL + "    \t\t\tstmtTmpBulk_";
  protected final String TEXT_430 = ");" + NL + "    \t\t\tstmtTmpBulk_";
  protected final String TEXT_431 = ".close();" + NL + "    \t\t\t";
  protected final String TEXT_432 = " has finished.\");" + NL + "    \t\t\t";
  protected final String TEXT_433 = NL + "    \t\t\ttableName_";
  protected final String TEXT_434 = " = tmpTableName_";
  protected final String TEXT_435 = ";" + NL + "    \t\t\ttmpTableName_";
  protected final String TEXT_436 = "\" + \"_\" + pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtUpdateBulk_";
  protected final String TEXT_437 = " - Updating ";
  protected final String TEXT_438 = " from ";
  protected final String TEXT_439 = "\"+tmpTableName_";
  protected final String TEXT_440 = "+\"";
  protected final String TEXT_441 = ".\");" + NL + "    \t\t\t";
  protected final String TEXT_442 = NL + "    \t\t\tstmtUpdateBulk_";
  protected final String TEXT_443 = "\");" + NL + "    \t\t\t";
  protected final String TEXT_444 = ".close();" + NL + "    \t\t\ttableName_";
  protected final String TEXT_445 = "\" + \"_\" +pid + Thread.currentThread().getId();" + NL + "    \t\t\tjava.sql.Statement stmtTmpDrop_";
  protected final String TEXT_446 = " - Droping temp table ";
  protected final String TEXT_447 = NL + "    \t\t\tstmtTmpDrop_";
  protected final String TEXT_448 = " - Drop temp table ";
  protected final String TEXT_449 = "+ \"";
  protected final String TEXT_450 = NL + "\t\tif(conn_";
  protected final String TEXT_451 = " != null && !conn_";
  protected final String TEXT_452 = ".isClosed()) {" + NL + "\t\t   ";
...
//end issue 0010346 Parallelization crash with "Drop table if exists and create"
    ...
    stringBuffer.append(additional_query_parameters);
