...
public class TWebServiceMainJava
{
  ...
  protected final String TEXT_34 = NL + "\t\tinMap_";
  protected final String TEXT_35 = " = new java.util.HashMap<String,Object>();" + NL + "\t\tjava.util.Map<String,Object> paramMap_";
  protected final String TEXT_36 = " = new java.util.HashMap<String,Object>();" + NL + "\t\tObject inputValueObject_";
  protected final String TEXT_37 = ";" + NL + "\t\tjavax.xml.namespace.QName anyTypeQName_";
  protected final String TEXT_38 = ";";
  protected final String TEXT_39 = "\t" + NL + "    \t\t\t\tinputValueObject_";
  protected final String TEXT_40 = " = util_";
  protected final String TEXT_41 = "\t" + NL + "\t\t\t\t\tinputValueObject_";
  protected final String TEXT_42 = " = ";
  protected final String TEXT_43 = NL + "\t\t\t\tparamMap_";
  protected final String TEXT_44 = ".put(util_";
  protected final String TEXT_45 = ".removePunctuation(\"";
  protected final String TEXT_46 = "\"),inputValueObject_";
  protected final String TEXT_47 = NL + "\t\tutil_";
  protected final String TEXT_48 = ".resolveInputPath(paramMap_";
  protected final String TEXT_49 = ");" + NL + "\t\tif(!paramMap_";
  protected final String TEXT_50 = ".isEmpty()){" + NL + "\t\t\tinMap_";
  protected final String TEXT_51 = " = org.talend.webservice.helper.map.MapConverter.mapToDeepMap(paramMap_";
  protected final String TEXT_52 = ");" + NL + "\t\t}" + NL + "\t\tif(inMap_";
  protected final String TEXT_53 = " = null;" + NL + "\t\t}";
  protected final String TEXT_54 = "\t" + NL + "\t java.util.Map<String, Object> results_";
  protected final String TEXT_55 = " = null;" + NL + "\t try{" + NL + "\t \t";
  protected final String TEXT_56 = NL + "\t \tresults_";
  protected final String TEXT_57 = " = serviceInvokerHelper_";
  protected final String TEXT_58 = ".invoke(serviceName_";
  protected final String TEXT_59 = ", portName_";
  protected final String TEXT_60 = ", \"";
  protected final String TEXT_61 = "\", inMap_";
  protected final String TEXT_62 = ");" + NL + "\t \t";
  protected final String TEXT_63 = NL + "\t }catch(java.lang.Exception e){";
  protected final String TEXT_64 = NL + "\t\tthrow(e);";
  protected final String TEXT_65 = NL + "\t\tSystem.err.print(e.getMessage());";
  protected final String TEXT_66 = NL + "\t }";
  protected final String TEXT_67 = "            \t\t" + NL + "\t\t\t\t\tjava.util.Map<String, Object> outMap_";
  protected final String TEXT_68 = "=null;" + NL + "\t\t\t\t\tif(results_";
  protected final String TEXT_69 = "!=null&&!results_";
  protected final String TEXT_70 = ".isEmpty()){" + NL + "\t\t\t\t\t\toutMap_";
  protected final String TEXT_71 = " = org.talend.webservice.helper.map.MapConverter.deepMapToMap(results_";
  protected final String TEXT_72 = ");" + NL + "\t\t\t\t\t}" + NL + "            \t\tjava.util.Map<String,Object> returnValuesMap_";
  protected final String TEXT_73 = " = new java.util.HashMap<String,Object>();" + NL + "            \t\tObject outputValue_";
  protected final String TEXT_74 = NL + "\t\t\t\t\toutputValue_";
  protected final String TEXT_75 = ".normalize(util_";
  protected final String TEXT_76 = ".getValue(outMap_";
  protected final String TEXT_77 = ",util_";
  protected final String TEXT_78 = "\")).toString(),\"";
  protected final String TEXT_79 = "\");";
  protected final String TEXT_80 = "    \t\t\t\t" + NL + "        \t\t\toutputValue_";
  protected final String TEXT_81 = ".denormalize((List)util_";
  protected final String TEXT_82 = "\")),\"";
  protected final String TEXT_83 = "\");    \t\t\t\t";
  protected final String TEXT_84 = NL + " \t\t\t\t\toutputValue_";
  protected final String TEXT_85 = "\"));";
  protected final String TEXT_86 = NL + "\t\t\t\t\treturnValuesMap_";
  protected final String TEXT_87 = ".put(\"";
  protected final String TEXT_88 = "\",outputValue_";
  protected final String TEXT_89 = ");\t\t";
  protected final String TEXT_90 = "\t\t\t\t" + NL + "\t\t\tif(returnValuesMap_";
  protected final String TEXT_91 = "!=null&&!returnValuesMap_";
  protected final String TEXT_92 = ".isEmpty()){";
  protected final String TEXT_93 = NL + NL + "\t\t\t\tif(returnValuesMap_";
  protected final String TEXT_94 = ".get(\"";
  protected final String TEXT_95 = "\")!=null){";
  protected final String TEXT_96 = "\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_97 = " = returnValuesMap_";
  protected final String TEXT_98 = "\").toString();";
  protected final String TEXT_99 = NL + "\t\t\t\t\t";
  protected final String TEXT_100 = " = ParserUtils.parseTo_Date(returnValuesMap_";
  protected final String TEXT_101 = "\").toString(), ";
  protected final String TEXT_102 = NL + "\t\t\t\t\tif(returnValuesMap_";
  protected final String TEXT_103 = "\") instanceof byte[]){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_104 = " = (byte[])returnValuesMap_";
  protected final String TEXT_105 = "\");\t" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_106 = "\").toString().getBytes();" + NL + "\t\t\t\t\t}";
  protected final String TEXT_107 = " = (List<Object>)returnValuesMap_";
  protected final String TEXT_108 = "\t\t\t\t\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_109 = " = ParserUtils.parseTo_";
  protected final String TEXT_110 = "(returnValuesMap_";
