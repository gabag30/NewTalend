...
package wipo_projects.g2a_val_tm_0_1;
...
/**
 * Job: G2a_Val_TM Purpose: alternative to store procedure using talend<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.4.1.20201110_1014-M4
 * @status 
 */
public class G2a_Val_TM implements TalendJob {
...
public String getProcessAll(){
	...
	private final String jobName = "G2a_Val_TM";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_7Gx3kHcZEems4uT2DBR07Q", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(G2a_Val_TM.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tDBSP_3_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
				
				end_Hash.put(errorComponent, System.currentTimeMillis());
				
				status = "failure";
				
					tDBSP_3_onSubJobError(exception, errorComponent, globalMap);
			}
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tDBSP_3_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public void tDBSP_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("tDBSP_3_SUBPROCESS_STATE", 0);
...
String dbschema_tDBSP_3 ="";
java.sql.Connection conn_tDBSP_3 = null;
String dbUser_tDBSP_3 = null;
	dbschema_tDBSP_3 = (String)globalMap.get("dbschema_tMSSqlConnection_3");
	
	conn_tDBSP_3 = (java.sql.Connection)globalMap.get("conn_tMSSqlConnection_3");
	
//java.sql.Statement stmt_tDBSP_3 = conn_tDBSP_3.createStatement();

//stmt_tDBSP_3.execute("SET NOCOUNT ON");
String spSchema_tDBSP_3 = "";
if(dbschema_tDBSP_3 != null && !dbschema_tDBSP_3.trim().isEmpty()) {
    spSchema_tDBSP_3 = "["+dbschema_tDBSP_3+"].";
}
java.sql.CallableStatement statement_tDBSP_3 = conn_tDBSP_3.prepareCall("{call " + spSchema_tDBSP_3 + "ImportMarkValidate" + "()}"
);

java.sql.Timestamp tmpDate_tDBSP_3;
 ...
 */
	...
	currentComponent="tDBSP_3";
			...
			while(statement_tDBSP_3.getMoreResults() || (statement_tDBSP_3.getUpdateCount() != -1)){
...
//stmt_tDBSP_3.execute("SET NOCOUNT OFF");
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tDBSP_3:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
 ...
 */
		...
		globalMap.put("tDBSP_3_SUBPROCESS_STATE", 1);
	}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_WIPO_PROJECTS_G2a_Val_TM = new byte[0];
    static byte[] commonByteArray_WIPO_PROJECTS_G2a_Val_TM = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WIPO_PROJECTS_G2a_Val_TM.length) {
				if(length < 1024 && commonByteArray_WIPO_PROJECTS_G2a_Val_TM.length == 0) {
   					commonByteArray_WIPO_PROJECTS_G2a_Val_TM = new byte[1024];
				} else {
   					commonByteArray_WIPO_PROJECTS_G2a_Val_TM = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WIPO_PROJECTS_G2a_Val_TM, 0, length);
			strReturn = new String(commonByteArray_WIPO_PROJECTS_G2a_Val_TM, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WIPO_PROJECTS_G2a_Val_TM) {
 ...
 */
    ...
    public static void main(String[] args){
        final G2a_Val_TM G2a_Val_TMClass = new G2a_Val_TM();

        int exitCode = G2a_Val_TMClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = G2a_Val_TM.class.getClassLoader().getResourceAsStream("wipo_projects/g2a_val_tm_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = G2a_Val_TM.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : G2a_Val_TM");
        }
...
/************************************************************************************************
 *     62287 characters generated by Talend Open Studio for Data Integration 
