...
/**
 * Job: G1_Val_mig_AGENTS Purpose: Validation and migration of agents from
 * intermediate to final tables<br>
 * Description: <br>
 * 
...
public class G1_Val_mig_AGENTS implements TalendJob {
	...
	public void tMSSqlSP_7_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tMSSqlSP_8_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tMSSqlSP_7_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tMSSqlSP_8_onSubJobError(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tMSSqlConnection_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tStatCatcher_1.addMessage("end", "tMSSqlConnection_3",
						end_Hash.get("tMSSqlConnection_3") - start_Hash.get("tMSSqlConnection_3"));
				tStatCatcher_1Process(globalMap);
...
//stmt_tMSSqlSP_7.execute("SET NOCOUNT ON");
				...
				java.sql.CallableStatement statement_tMSSqlSP_7 = conn_tMSSqlSP_7
						.prepareCall("{call " + spSchema_tMSSqlSP_7 + "ImportAgentValidate" + "()}");
...
//stmt_tMSSqlSP_7.close();
				...
				tStatCatcher_1.addMessage("end", "tMSSqlSP_7",
						end_Hash.get("tMSSqlSP_7") - start_Hash.get("tMSSqlSP_7"));
				tStatCatcher_1Process(globalMap);
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tMSSqlSP_7:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
...
//stmt_tMSSqlSP_8.execute("SET NOCOUNT ON");
				...
				java.sql.CallableStatement statement_tMSSqlSP_8 = conn_tMSSqlSP_8
						.prepareCall("{call " + spSchema_tMSSqlSP_8 + "ImportAgentProcessAll" + "()}");
...
//stmt_tMSSqlSP_8.close();
				...
				tStatCatcher_1.addMessage("end", "tMSSqlSP_8",
						end_Hash.get("tMSSqlSP_8") - start_Hash.get("tMSSqlSP_8"));
				tStatCatcher_1Process(globalMap);
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tMSSqlSP_8:OnSubjobOk", "",
						Thread.currentThread().getId() + "", "", "", "", "", "");
			}
	...
	public void tDBClose_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				tStatCatcher_1.addMessage("end", "tDBClose_1",
						end_Hash.get("tDBClose_1") - start_Hash.get("tDBClose_1"));
				tStatCatcher_1Process(globalMap);
...
///////////////////////		
					...
					if (row30.moment != null) { //
						...
						strBuffer_tLogRow_1.append(FormatterUtils.format_Date(row30.moment, "yyyy-MM-dd HH:mm:ss"));
					...
					if (row30.job != null) { //
						...
						strBuffer_tLogRow_1.append(String.valueOf(row30.job));
					...
					if (row30.context != null) { //
						...
						strBuffer_tLogRow_1.append(String.valueOf(row30.context));
					...
					if (row30.origin != null) { //
						...
						strBuffer_tLogRow_1.append(String.valueOf(row30.origin));
					...
					if (row30.message_type != null) { //
						...
						strBuffer_tLogRow_1.append(String.valueOf(row30.message_type));
					...
					if (row30.message != null) { //
						...
						strBuffer_tLogRow_1.append(String.valueOf(row30.message));
					...
					if (row30.duration != null) { //
						...
						strBuffer_tLogRow_1.append(String.valueOf(row30.duration));
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = G1_Val_mig_AGENTS.class.getClassLoader()
					.getResourceAsStream("wipo_projects/g1_val_mig_agents_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = G1_Val_mig_AGENTS.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : G1_Val_mig_AGENTS");
		}
...
/************************************************************************************************
 * 69624 characters generated by Talend Open Studio for Data Integration on the
 * November 2, 2020 at 5:17:05 PM CET
 ************************************************************************************************/