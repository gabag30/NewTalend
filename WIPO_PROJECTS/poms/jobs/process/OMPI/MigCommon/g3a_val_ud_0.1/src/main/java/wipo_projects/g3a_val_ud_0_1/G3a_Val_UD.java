...
package wipo_projects.g3a_val_ud_0_1;
...
/**
 * Job: G3a_Val_UD Purpose: alternative to store procedure using talend<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.4.1.20201110_1014-M4
 * @status 
 */
public class G3a_Val_UD implements TalendJob {
...
public String getProcessAll(){
	...
	private final String jobName = "G3a_Val_UD";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_iVESAD9hEemo3_NJHT1Xgw", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(G3a_Val_UD.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		start_Hash.put("tDBSP_1", System.currentTimeMillis());
				...
				tStatCatcher_1.addMessage("begin","tDBSP_1");
				tStatCatcher_1Process(globalMap);
...
String dbUser_tDBSP_1 = null;
	dbschema_tDBSP_1 = (String)globalMap.get("dbschema_tMSSqlConnection_3");
	
	conn_tDBSP_1 = (java.sql.Connection)globalMap.get("conn_tMSSqlConnection_3");
...
java.sql.CallableStatement statement_tDBSP_1 = conn_tDBSP_1.prepareCall("{call " + spSchema_tDBSP_1 + "ImportUserdocValidate" + "()}"
);
...
tStatCatcher_1.addMessage("end","tDBSP_1", end_Hash.get("tDBSP_1")-start_Hash.get("tDBSP_1"));
tStatCatcher_1Process(globalMap);
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tDBSP_1:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_WIPO_PROJECTS_G3a_Val_UD = new byte[0];
    static byte[] commonByteArray_WIPO_PROJECTS_G3a_Val_UD = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WIPO_PROJECTS_G3a_Val_UD.length) {
				if(length < 1024 && commonByteArray_WIPO_PROJECTS_G3a_Val_UD.length == 0) {
   					commonByteArray_WIPO_PROJECTS_G3a_Val_UD = new byte[1024];
				} else {
   					commonByteArray_WIPO_PROJECTS_G3a_Val_UD = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WIPO_PROJECTS_G3a_Val_UD, 0, length);
			strReturn = new String(commonByteArray_WIPO_PROJECTS_G3a_Val_UD, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WIPO_PROJECTS_G3a_Val_UD) {
 ...
 */
    ...
    public static void main(String[] args){
        final G3a_Val_UD G3a_Val_UDClass = new G3a_Val_UD();

        int exitCode = G3a_Val_UDClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = G3a_Val_UD.class.getClassLoader().getResourceAsStream("wipo_projects/g3a_val_ud_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = G3a_Val_UD.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : G3a_Val_UD");
        }
...
/************************************************************************************************
 *     62689 characters generated by Talend Open Studio for Data Integration 
 *     on the November 25, 2020 at 4:47:18 PM CET
 ************************************************************************************************/