...
package wipo_projects.mark_resize_0_3;
 ...
 * @status
 */
public class MARK_RESIZE implements TalendJob {
	...
	private final String jobName = "MARK_RESIZE";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MARK_RESIZE.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class updateStruct implements routines.system.IPersistableRow<updateStruct> {
		final static byte[] commonByteArrayLock_WIPO_PROJECTS_MARK_RESIZE = new byte[0];
		static byte[] commonByteArray_WIPO_PROJECTS_MARK_RESIZE = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_WIPO_PROJECTS_MARK_RESIZE.length) {
					if (length < 1024 && commonByteArray_WIPO_PROJECTS_MARK_RESIZE.length == 0) {
						commonByteArray_WIPO_PROJECTS_MARK_RESIZE = new byte[1024];
					} else {
						commonByteArray_WIPO_PROJECTS_MARK_RESIZE = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_WIPO_PROJECTS_MARK_RESIZE, 0, length);
				strReturn = new String(commonByteArray_WIPO_PROJECTS_MARK_RESIZE, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_WIPO_PROJECTS_MARK_RESIZE) {
	...
	public static class delete_wrong_dataStruct implements routines.system.IPersistableRow<delete_wrong_dataStruct> {
		final static byte[] commonByteArrayLock_WIPO_PROJECTS_MARK_RESIZE = new byte[0];
		static byte[] commonByteArray_WIPO_PROJECTS_MARK_RESIZE = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final delete_wrong_dataStruct other = (delete_wrong_dataStruct) obj;
		...
		public void copyDataTo(delete_wrong_dataStruct other) {
		...
		public void copyKeysDataTo(delete_wrong_dataStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(delete_wrong_dataStruct other) {
	...
	public void tOracleInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				delete_wrong_dataStruct delete_wrong_data = new delete_wrong_dataStruct();
				...
				String update_tOracleOutput_1 = "UPDATE " + tableName_tOracleOutput_1
						+ " SET LOGO_DATA = ?,IMAGE_FORMAT_WCODE = ? WHERE ((FILE_SEQ IS NULL AND 1 = ?) OR FILE_SEQ=?) AND ((FILE_TYP IS NULL AND 1 = ?) OR FILE_TYP=?) AND ((FILE_SER IS NULL AND 1 = ?) OR FILE_SER=?) AND ((FILE_NBR IS NULL AND 1 = ?) OR FILE_NBR=?)";
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "delete_wrong_data");
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("IP_LOGO");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "." + ("IP_LOGO");
				}
				String delete_tDBOutput_1 = "DELETE FROM " + tableName_tDBOutput_1
						+ " WHERE ((FILE_SEQ IS NULL AND 1 = ?) OR FILE_SEQ=?) AND ((FILE_TYP IS NULL AND 1 = ?) OR FILE_TYP=?) AND ((FILE_SER IS NULL AND 1 = ?) OR FILE_SER=?) AND ((FILE_NBR IS NULL AND 1 = ?) OR FILE_NBR=?)";
...
// # Outputs initialization
				...
				delete_wrong_dataStruct delete_wrong_data_tmp = new delete_wrong_dataStruct();
// ###############################
				...
				try {
					...
					while (rs_tOracleInput_1.next()) {
						...
						row2.LOGO_DATA = IPAS.resize(row1.LOGO_DATA, context.ImageSizeMax);
...
// # Output table : 'delete_wrong_data'
// # Filter conditions 
							if (
							...
							row2.LOGO_DATA == null
								...
								delete_wrong_data_tmp.FILE_SEQ = row2.FILE_SEQ;
								delete_wrong_data_tmp.FILE_TYP = row2.FILE_TYP;
								delete_wrong_data_tmp.FILE_SER = row2.FILE_SER;
								delete_wrong_data_tmp.FILE_NBR = row2.FILE_NBR;
								delete_wrong_data = delete_wrong_data_tmp;
							} // closing filter/reject
// ###############################
...
// Start of branch "update"
						if (update != null) {
							...
							pstmt_tOracleOutput_1.setInt(3, ((update.FILE_SEQ == null) ? 1 : 0));

							if (update.FILE_SEQ == null) {
								pstmt_tOracleOutput_1.setNull(4 + count_tOracleOutput_1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tOracleOutput_1.setString(4 + count_tOracleOutput_1, update.FILE_SEQ);
							}

							pstmt_tOracleOutput_1.setInt(5, ((update.FILE_TYP == null) ? 1 : 0));

							if (update.FILE_TYP == null) {
								pstmt_tOracleOutput_1.setNull(6 + count_tOracleOutput_1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tOracleOutput_1.setString(6 + count_tOracleOutput_1, update.FILE_TYP);
							}

							pstmt_tOracleOutput_1.setInt(7, ((update.FILE_SER == null) ? 1 : 0));

							pstmt_tOracleOutput_1.setBigDecimal(8 + count_tOracleOutput_1, update.FILE_SER);

							pstmt_tOracleOutput_1.setInt(9, ((update.FILE_NBR == null) ? 1 : 0));

							pstmt_tOracleOutput_1.setBigDecimal(10 + count_tOracleOutput_1, update.FILE_NBR);
...
// Start of branch "delete_wrong_data"
						if (delete_wrong_data != null) {
							...
							pstmt_tDBOutput_1.setInt(1, ((delete_wrong_data.FILE_SEQ == null) ? 1 : 0));

							if (delete_wrong_data.FILE_SEQ == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, delete_wrong_data.FILE_SEQ);
							}

							pstmt_tDBOutput_1.setInt(3, ((delete_wrong_data.FILE_TYP == null) ? 1 : 0));

							if (delete_wrong_data.FILE_TYP == null) {
								pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4, delete_wrong_data.FILE_TYP);
							}

							pstmt_tDBOutput_1.setInt(5, ((delete_wrong_data.FILE_SER == null) ? 1 : 0));

							pstmt_tDBOutput_1.setBigDecimal(6, delete_wrong_data.FILE_SER);

							pstmt_tDBOutput_1.setInt(7, ((delete_wrong_data.FILE_NBR == null) ? 1 : 0));

							pstmt_tDBOutput_1.setBigDecimal(8, delete_wrong_data.FILE_NBR);
						...
						} // End of branch "delete_wrong_data"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "delete_wrong_data");
				}
	...
	public static void main(String[] args) {
		final MARK_RESIZE MARK_RESIZEClass = new MARK_RESIZE();

		int exitCode = MARK_RESIZEClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MARK_RESIZE.class.getClassLoader()
					.getResourceAsStream("wipo_projects/mark_resize_0_3/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = MARK_RESIZE.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MARK_RESIZE");
		}
...
/************************************************************************************************
 * 93564 characters generated by Talend Open Studio for Data Integration on the
 * February 4, 2021 at 8:11:50 AM CET
 ************************************************************************************************/