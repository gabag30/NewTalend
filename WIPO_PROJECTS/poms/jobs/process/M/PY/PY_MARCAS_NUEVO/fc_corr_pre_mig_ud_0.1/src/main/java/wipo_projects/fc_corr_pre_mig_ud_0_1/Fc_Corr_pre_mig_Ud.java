...
package wipo_projects.fc_corr_pre_mig_ud_0_1;
...
/**
 * Job: Fc_Corr_pre_mig_Ud Purpose: automatizar el proceso de validación de la migración<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.4.1.20201110_1014-M4
 * @status 
 */
public class Fc_Corr_pre_mig_Ud implements TalendJob {
...
public String getIntermediateDB(){
	...
	private final String jobName = "Fc_Corr_pre_mig_Ud";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_V6ofoN7YEem7Qe8o507aSw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Fc_Corr_pre_mig_Ud.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Fc_Corr_pre_mig_Ud.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    final static byte[] commonByteArrayLock_WIPO_PROJECTS_Fc_Corr_pre_mig_Ud = new byte[0];
    static byte[] commonByteArray_WIPO_PROJECTS_Fc_Corr_pre_mig_Ud = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WIPO_PROJECTS_Fc_Corr_pre_mig_Ud.length) {
				if(length < 1024 && commonByteArray_WIPO_PROJECTS_Fc_Corr_pre_mig_Ud.length == 0) {
   					commonByteArray_WIPO_PROJECTS_Fc_Corr_pre_mig_Ud = new byte[1024];
				} else {
   					commonByteArray_WIPO_PROJECTS_Fc_Corr_pre_mig_Ud = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WIPO_PROJECTS_Fc_Corr_pre_mig_Ud, 0, length);
			strReturn = new String(commonByteArray_WIPO_PROJECTS_Fc_Corr_pre_mig_Ud, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WIPO_PROJECTS_Fc_Corr_pre_mig_Ud) {
...
query_tDBRow_1 = "\nupdate "+context.intermediateDB+".[dbo].[VW_IMPORT_USERDOC_OWNERS] set NATIONALITY_COUNTRY_CODE='PY' where NATIONALITY_COUNTRY_CODE not in (select count"
+"ry_code from CF_GEO_COUNTRY);\nupdate "+context.intermediateDB+".[dbo].[VW_IMPORT_USERDOC_OWNERS] set RESIDENCE_COUNTRY_CODE='PY' where RESIDENCE_COUNTRY_CODE not in (select country_c"
+"ode from CF_GEO_COUNTRY);\nupdate "+context.intermediateDB+".[dbo].[VW_IMPORT_USERDOC_REPRS] set NATIONALITY_COUNTRY_CODE='PY' where NATIONALITY_COUNTRY_CODE not in (select countr"
+"y_code from CF_GEO_COUNTRY);\nupdate "+context.intermediateDB+".[dbo].[VW_IMPORT_USERDOC_REPRS] set RESIDENCE_COUNTRY_CODE='PY' where RESIDENCE_COUNTRY_CODE not in (select country_co"
+"de from CF_GEO_COUNTRY);\nupdate "+context.intermediateDB+".[dbo].[VW_IMPORT_USERDOC] set NATIONALITY_COUNTRY_CODE='PY' where NATIONALITY_COUNTRY_CODE not in (select country_code"
+" from CF_GEO_COUNTRY);\nupdate "+context.intermediateDB+".[dbo].[VW_IMPORT_USERDOC] set RESIDENCE_COUNTRY_CODE='PY' where RESIDENCE_COUNTRY_CODE not in (select country_code fro"
+"m CF_GEO_COUNTRY);\n\n\nWITH CTE AS(\n   SELECT\n       RN = ROW_NUMBER()OVER\n(PARTITION BY USERDOC_SEQ,\n			 USERDOC_S"
+"ERIES,\n			 USERDOC_NBR,ind_service ORDER BY userdoc_NBR),*\n  FROM   "+context.intermediateDB+".[dbo].vw_import_userdoc_reprs)\nupdate CTE set IND_SERVICE=0 where rn>1;\n\n";
 ...
 */
    ...
    public static void main(String[] args){
        final Fc_Corr_pre_mig_Ud Fc_Corr_pre_mig_UdClass = new Fc_Corr_pre_mig_Ud();

        int exitCode = Fc_Corr_pre_mig_UdClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Fc_Corr_pre_mig_Ud.class.getClassLoader().getResourceAsStream("wipo_projects/fc_corr_pre_mig_ud_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Fc_Corr_pre_mig_Ud.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Fc_Corr_pre_mig_Ud");
        }
...
/************************************************************************************************
 *     66901 characters generated by Talend Open Studio for Data Integration 
