...
// Exception is thrown if db don't support, no need to catch exception here
				...
				java.sql.ResultSet rs = stm.executeQuery(
						"SELECT     sec_documento,     tip_documento,     num_acta_documento,     num_acta,     num_registro,     fec_documento,     obs_documento,     nom_solicitante,     cod_pais,     num_agente,     fec_ingreso,     tip_tramite,     cod_status,     fec_status,     num_registro_poder,     num_agente_old,     cobro_caja,     ref_pago  FROM documento       where   num_acta     in (select  num_acta      FROM marca)");
...
/************************************************************************************************
 * 41480 characters generated by Talend Open Studio for Data Integration on the
 * October 30, 2020 at 5:02:20 PM CET
 ************************************************************************************************/