...
public class TMSSqlRowFinallyJava
{
  ...
  protected final String TEXT_57 = NL + "    if (resourceMap.get(\"statementClosed_";
  protected final String TEXT_58 = "\") == null) {";
  protected final String TEXT_59 = NL + "            java.sql.PreparedStatement pstmtToClose_";
  protected final String TEXT_60 = " = null;" + NL + "            if ((pstmtToClose_";
  protected final String TEXT_61 = " = (java.sql.PreparedStatement) resourceMap.remove(\"pstmt_";
  protected final String TEXT_62 = "\")) != null) {" + NL + "                pstmtToClose_";
  protected final String TEXT_63 = ".close();" + NL + "            }";
  protected final String TEXT_64 = NL + "            java.sql.Statement stmtToClose_";
  protected final String TEXT_65 = " = null;" + NL + "            if ((stmtToClose_";
  protected final String TEXT_66 = " = (java.sql.Statement) resourceMap.remove(\"stmt_";
  protected final String TEXT_67 = "\")) != null) {" + NL + "                stmtToClose_";
  ...
  protected final String TEXT_74 = NL + "                    ctn_";
  protected final String TEXT_75 = ".close();";
  protected final String TEXT_76 = NL + "                } catch (java.sql.SQLException sqlEx_";
  protected final String TEXT_77 = ") {" + NL + "                    String errorMessage_";
  protected final String TEXT_78 = " = \"failed to close the connection in ";
  protected final String TEXT_79 = " :\" + sqlEx_";
  protected final String TEXT_80 = ".getMessage();";
  protected final String TEXT_81 = NL + "                    System.err.println(errorMessage_";
  protected final String TEXT_82 = ");" + NL + "                }" + NL + "            }" + NL + "        }" + NL + "    }";
