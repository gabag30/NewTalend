...
public class TMSSqlOutputMainJava {
  ...
  protected final String TEXT_212 = ".getMetaData();";
  protected final String TEXT_213 = NL + "                                    java.sql.ResultSet rsTable_";
  protected final String TEXT_214 = ".getTables(";
  protected final String TEXT_215 = ", null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_216 = ".getTables(conn_";
  protected final String TEXT_217 = ".getCatalog(), null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_218 = " = false;" + NL + "                                while(rsTable_";
  protected final String TEXT_219 = ".next()) {" + NL + "                                    String table_";
  protected final String TEXT_220 = ".getString(\"TABLE_NAME\");" + NL + "                                    if(table_";
  protected final String TEXT_221 = ".equalsIgnoreCase(";
  protected final String TEXT_222 = ")) {" + NL + "                                        whetherExist_";
  protected final String TEXT_223 = " = true;" + NL + "                                        break;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_224 = ".getString(\"TABLE_NAME\");" + NL + "                                        if(table_";
  protected final String TEXT_225 = NL + "                                if(!whetherExist_";
  protected final String TEXT_226 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  protected final String TEXT_227 = NL + "                                                      stmtCreate_";
  protected final String TEXT_228 = NL + "                                            routines.system.Dynamic dynamic_";
  protected final String TEXT_229 = ";" + NL + "\t\t\t\t\t\t                    if (";
  protected final String TEXT_230 = ") {" + NL + "\t\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_231 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_232 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t\t                        }" + NL + "\t\t\t\t\t\t                    }" + NL + "                                            stmtCreate_";
  protected final String TEXT_233 = NL + "                                        stmtCreate_";
  protected final String TEXT_234 = NL + "                                    }" + NL + "                                }";
  protected final String TEXT_235 = NL + "                                if(whetherExist_";
  protected final String TEXT_236 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  ...
  protected final String TEXT_241 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  protected final String TEXT_242 = NL + "                                                  stmtCreate_";
  protected final String TEXT_243 = NL + "\t\t                                routines.system.Dynamic dynamic_";
  protected final String TEXT_244 = ";" + NL + "\t\t\t\t\t                    if (";
  protected final String TEXT_245 = ") {" + NL + "\t\t\t\t\t                        for (int i = 0; i < dynamic_";
  protected final String TEXT_246 = ".getColumnCount(); i++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column = dynamic_";
  protected final String TEXT_247 = ".getColumnMetadata(i);" + NL + "\t\t\t\t\t                        \tcolumn.setName(column.getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  ...
  protected final String TEXT_252 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_253 = NL + "                              stmtClear_";
  protected final String TEXT_254 = NL + "                stmtClear_";
  protected final String TEXT_255 = ".executeUpdate(\"";
  protected final String TEXT_256 = "\");";
  protected final String TEXT_257 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_258 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_259 = NL + "                              stmtTruncCount_";
  protected final String TEXT_260 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_261 = " = stmtTruncCount_";
  protected final String TEXT_262 = ".executeQuery(\"";
  protected final String TEXT_263 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_264 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_265 = " = rsTruncCount_";
  protected final String TEXT_266 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_267 = NL + "                              stmtTrunc_";
  protected final String TEXT_268 = NL + "                conn_";
  protected final String TEXT_269 = NL + "                stmtTrunc_";
  protected final String TEXT_270 = NL + "                    if(!conn_";
  protected final String TEXT_271 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_272 = ".commit();" + NL + "                    }";
  protected final String TEXT_273 = NL + "                deletedCount_";
  protected final String TEXT_274 = " += rsTruncCountNumber_";
  protected final String TEXT_275 = ";" + NL + "            }";
  protected final String TEXT_276 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_279 = NL + "                while(rsTruncCount_";
  protected final String TEXT_280 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_281 = " += rsTruncCount_";
  protected final String TEXT_282 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_283 = NL + "\t\t\t\tString insert_";
  protected final String TEXT_284 = " = \"INSERT INTO [\" + tableName_";
  protected final String TEXT_285 = " + \"] (";
  protected final String TEXT_286 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_287 = "\")+\") VALUES (";
  protected final String TEXT_288 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_289 = ")+\")\";";
  protected final String TEXT_290 = " + \"] (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_291 = "\")+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_292 = NL + "        //String insert_";
  protected final String TEXT_293 = ") VALUES (";
  protected final String TEXT_294 = ")\";";
  protected final String TEXT_295 = NL + "        pstmt_";
  ...
  protected final String TEXT_300 = " = null;" + NL + "        // [%connection%][psmt][tableName]" + NL + "        String keyPsmt_";
  protected final String TEXT_301 = " + \"[psmt]\" + \"[\" + ";
  protected final String TEXT_302 = " + \"]\";" + NL + "\t\tif(GlobalResource.resourceMap.get(keyPsmt_";
  protected final String TEXT_303 = ")== null){" + NL + "\t\t\tpstmt_";
  protected final String TEXT_304 = ");" + NL + "\t\t\tresourceMap.put(\"pstmt_";
  protected final String TEXT_305 = ");" + NL + "\t\t\tGlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_306 = ", pstmt_";
  protected final String TEXT_307 = ");" + NL + "\t\t}else{" + NL + "\t\t\tpstmt_";
  protected final String TEXT_308 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_313 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_314 = "\")+\" WHERE ";
  protected final String TEXT_315 = "\";";
  protected final String TEXT_316 = " + \"] SET \"+DynamicUtils.getUpdateSet(";
  ...
  protected final String TEXT_320 = "\");" + NL + "        resourceMap.put(\"pstmt_";
  protected final String TEXT_321 = ");" + NL + "        pstmtInsert_";
  protected final String TEXT_322 = ");" + NL + "        resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_323 = "\", pstmtInsert_";
  protected final String TEXT_324 = ");" + NL + "        pstmtUpdate_";
  protected final String TEXT_325 = ");" + NL + "        resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_326 = "\", pstmtUpdate_";
  protected final String TEXT_327 = NL + "        pstmtUpdate_";
  protected final String TEXT_328 = NL + "        String delete_";
  protected final String TEXT_329 = " = \"DELETE FROM [\" + tableName_";
  protected final String TEXT_330 = ".prepareStatement(delete_";
  protected final String TEXT_331 = NL + "        java.sql.PreparedStatement pstmt_";
  protected final String TEXT_332 = NL + "       \t";
  protected final String TEXT_333 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_334 = " = insert_";
  protected final String TEXT_335 = ".split(\"\\\\?\");";
  protected final String TEXT_336 = NL + "\t\t\tupdate_";
  protected final String TEXT_337 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_338 = " = update_";
  protected final String TEXT_339 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_340 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_341 = NL + "\t\t\tdelete_";
  protected final String TEXT_342 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_343 = " = delete_";
  protected final String TEXT_344 = NL + "\t\t\treplace_";
  protected final String TEXT_345 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_346 = " = replace_";
  protected final String TEXT_347 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_348 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_349 = " = insertIgnore_";
  protected final String TEXT_350 = NL + "\t        if ( !isShareIdentity_";
  protected final String TEXT_351 = " ) {" + NL + "\t            stmt_";
  protected final String TEXT_352 = ".execute(\"SET IDENTITY_INSERT [\"+ tableName_";
  protected final String TEXT_353 = " +\"] ON\");" + NL + "\t        }";
  protected final String TEXT_354 = NL + "            stmt_";
  protected final String TEXT_355 = " +\"] ON\");" + NL + "     \t";
  protected final String TEXT_356 = NL + "\t\t}" + NL + "\t";
  protected final String TEXT_357 = NL + "\t\t\t\tcommitEvery_";
  protected final String TEXT_358 = " = buffersSize_";
  protected final String TEXT_359 = ";";
  protected final String TEXT_360 = NL + "\t\t\tbatchSize_";
  protected final String TEXT_361 = NL + NL;
  protected final String TEXT_362 = NL + "\t        if(isShareIdentity_";
  protected final String TEXT_363 = ") {" + NL + "\t            stmt_";
  protected final String TEXT_364 = NL + "        whetherReject_";
  protected final String TEXT_365 = " = false;";
  protected final String TEXT_366 = NL + "            try {";
  protected final String TEXT_367 = NL + "                        query_";
  protected final String TEXT_368 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_369 = ",insertSQLSplits_";
  protected final String TEXT_370 = NL + "\t\t\t\t\tDynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_452 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_453 = " > 0) {";
  protected final String TEXT_454 = NL + "                            query_";
  protected final String TEXT_455 = NL + "\t\t\t\t\t\t\troutines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_456 = ");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_457 = NL + "\t\t\t\t\t\tint count_";
  protected final String TEXT_458 = ", pstmtUpdate_";
