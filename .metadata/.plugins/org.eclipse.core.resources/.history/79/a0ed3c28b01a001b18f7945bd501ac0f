...
public class FooterJava
{
  ...
  protected final String TEXT_72 = ".setProperty(\"host\", \"false\");" + NL + "" + NL + "\t\t\t\tSystem.getProperties().stringPropertyNames().stream()" + NL + "\t\t\t\t\t.filter(it -> it.startsWith(\"audit.logger.\"))" + NL + "\t\t\t\t\t.forEach(key -> properties_";
  protected final String TEXT_73 = ".setProperty(key.substring(\"audit.logger.\".length()), System.getProperty(key)));" + NL + "" + NL + "\t\t\t\t";
  protected final String TEXT_74 = NL + "\t\t\t\torg.apache.log4j.Logger.getLogger(properties_";
  protected final String TEXT_75 = ".getProperty(\"root.logger\")).setLevel(org.apache.log4j.Level.DEBUG);" + NL + "\t\t\t\t";
  protected final String TEXT_76 = NL + "\t\t\t\torg.apache.logging.log4j.core.config.Configurator.setLevel(properties_";
  protected final String TEXT_77 = ".getProperty(\"root.logger\"), org.apache.logging.log4j.Level.DEBUG);" + NL + "\t\t\t\t";
  protected final String TEXT_78 = NL + "\t\t\t\tauditLogger_";
  protected final String TEXT_79 = " = org.talend.job.audit.JobEventAuditLoggerFactory.createJobAuditLogger(properties_";
  protected final String TEXT_80 = ");" + NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_81 = NL + NL + "        if(clientHost == null) {" + NL + "            clientHost = defaultClientHost;" + NL + "        }" + NL + "" + NL + "        if(pid == null || \"0\".equals(pid)) {" + NL + "            pid = TalendString.getAsciiRandomString(6);" + NL + "        }" + NL + "" + NL + "        if (rootPid==null) {" + NL + "            rootPid = pid;" + NL + "        }" + NL + "        if (fatherPid==null) {" + NL + "            fatherPid = pid;" + NL + "        }else{" + NL + "            isChildJob = true;" + NL + "        }" + NL;
  ...
  protected final String TEXT_83 = NL + NL + "        try {" + NL + "            //call job/subjob with an existing context, like: --context=production. if without this parameter, there will use the default context instead." + NL + "            java.io.InputStream inContext = ";
  protected final String TEXT_84 = ".class.getClassLoader().getResourceAsStream(\"";
  protected final String TEXT_85 = "/contexts/\" + contextStr + \".properties\");" + NL + "            if (inContext == null) {" + NL + "                inContext = ";
  protected final String TEXT_86 = ".class.getClassLoader().getResourceAsStream(\"config/contexts/\" + contextStr + \".properties\");" + NL + "            }" + NL + "            if (inContext != null) {" + NL + "                //defaultProps is in order to keep the original context value" + NL + "                if(context != null && context.isEmpty()) {" + NL + "\t                defaultProps.load(inContext);" + NL + "\t                context = new ContextProperties(defaultProps);" + NL + "                }" + NL + "                " + NL + "                inContext.close();" + NL + "            } else if (!isDefaultContext) {" + NL + "                //print info and job continue to run, for case: context_param is not empty." + NL + "                System.err.println(\"Could not find the context \" + contextStr);" + NL + "            }" + NL + "" + NL + "            if(!context_param.isEmpty()) {" + NL + "                context.putAll(context_param);" + NL + "\t\t\t\t//set types for params from parentJobs" + NL + "\t\t\t\tfor (Object key: context_param.keySet()){" + NL + "\t\t\t\t\tString context_key = key.toString();" + NL + "\t\t\t\t\tString context_type = context_param.getContextType(context_key);" + NL + "\t\t\t\t\tcontext.setContextType(context_key, context_type);" + NL + "" + NL + "\t\t\t\t}" + NL + "            }";
  protected final String TEXT_87 = NL + "            class ContextProcessing {" + NL + "                private void processContext_0() {";
  protected final String TEXT_88 = NL + "                        }" + NL + "" + NL + "                private void processContext_";
  protected final String TEXT_89 = "() {";
  protected final String TEXT_90 = NL + "                        context.setContextType(\"";
  protected final String TEXT_91 = "\", \"";
  protected final String TEXT_92 = "\");" + NL + "                        if(context.getStringValue(\"";
  protected final String TEXT_93 = "\") == null) {" + NL + "                            context.";
  protected final String TEXT_94 = " = null;" + NL + "                        } else {";
  protected final String TEXT_95 = NL + "                            String pwd_";
  protected final String TEXT_96 = "_value = context.getProperty(\"";
  protected final String TEXT_97 = "\");" + NL + "                            context.";
  protected final String TEXT_98 = " = null;" + NL + "                            if(pwd_";
  protected final String TEXT_99 = "_value!=null) {" + NL + "                                if(context_param.containsKey(\"";
  protected final String TEXT_100 = "\")) {//no need to decrypt if it come from program argument or parent job runtime" + NL + "                                    context.";
  protected final String TEXT_101 = " = pwd_";
  protected final String TEXT_102 = "_value;" + NL + "                                } else if (!pwd_";
  protected final String TEXT_103 = "_value.isEmpty()) {" + NL + "                                    try {" + NL + "                                        context.";
  protected final String TEXT_104 = " = routines.system.PasswordEncryptUtil.decryptPassword(pwd_";
  protected final String TEXT_105 = "_value);" + NL + "                                        context.put(\"";
  protected final String TEXT_106 = "\",context.";
  protected final String TEXT_107 = ");" + NL + "                                    } catch (java.lang.RuntimeException e) {" + NL + "                                        //do nothing" + NL + "                                    }" + NL + "                                } else {" + NL + "                                    context.";
  protected final String TEXT_108 = "_value;" + NL + "                                    context.put(\"";
  protected final String TEXT_109 = ");" + NL + "                                }" + NL + "                            }";
  protected final String TEXT_110 = NL + "                            String context_";
  protected final String TEXT_111 = "\");" + NL + "                            try{" + NL + "                                if (context_";
  protected final String TEXT_112 = "_value == null){" + NL + "                                    context_";
  protected final String TEXT_113 = "_value = \"\";" + NL + "                                }" + NL + "                                int context_";
  protected final String TEXT_114 = "_pos = context_";
  protected final String TEXT_115 = "_value.indexOf(\";\");" + NL + "                                String context_";
  protected final String TEXT_116 = "_pattern =  \"yyyy-MM-dd HH:mm:ss\";" + NL + "                                if(context_";
  protected final String TEXT_117 = "_pos > -1){" + NL + "                                    context_";
  protected final String TEXT_118 = "_pattern = context_";
  protected final String TEXT_119 = "_value.substring(0, context_";
  protected final String TEXT_120 = "_pos);" + NL + "                                    context_";
  protected final String TEXT_121 = "_value = context_";
  protected final String TEXT_122 = "_value.substring(context_";
  protected final String TEXT_123 = "_pos + 1);" + NL + "                                }" + NL + "" + NL + "                                context.";
  protected final String TEXT_124 = "=(java.util.Date)(new java.text.SimpleDateFormat(context_";
  protected final String TEXT_125 = "_pattern).parse(context_";
  protected final String TEXT_126 = "_value));" + NL + "" + NL + "                            } catch(ParseException e) {" + NL + "                                try { ";
  protected final String TEXT_127 = NL + "                                    long context_";
  protected final String TEXT_128 = "_longValue = Long.valueOf(context_";
  protected final String TEXT_129 = "_value);" + NL + "                                    context.";
  protected final String TEXT_130 = " = new java.util.Date(context_";
  protected final String TEXT_131 = "_longValue);" + NL + "                                } catch (NumberFormatException cantParseToLongException) {";
  protected final String TEXT_132 = NL + "                                        log.warn(String.format(\"";
  protected final String TEXT_133 = "\", \"Can't parse date string: \" + e.getMessage() + \" and long: \" + cantParseToLongException.getMessage()));";
  protected final String TEXT_134 = NL + "                                        System.err.println(String.format(\"";
  protected final String TEXT_135 = NL + "                                    context.";
  protected final String TEXT_136 = "=null;" + NL + "                                }" + NL + "                            }";
  protected final String TEXT_137 = NL + "                            context.";
  protected final String TEXT_138 = "=(";
  protected final String TEXT_139 = ") context.getProperty(\"";
  protected final String TEXT_140 = "= new java.text.StringCharacterIterator(context.getProperty(\"";
  protected final String TEXT_141 = "\")).first();";
  protected final String TEXT_142 = NL + "                            try{" + NL + "                                context.";
  protected final String TEXT_143 = "=routines.system.ParserUtils.parseTo_";
  protected final String TEXT_144 = " (context.getProperty(\"";
  protected final String TEXT_145 = "\"));" + NL + "                            } catch(NumberFormatException e){";
  protected final String TEXT_146 = NL + "                                log.warn(String.format(\"";
  protected final String TEXT_147 = "\", e.getMessage()));";
  protected final String TEXT_148 = NL + "                                System.err.println(String.format(\"";
  protected final String TEXT_149 = NL + "                                context.";
  protected final String TEXT_150 = "=null;" + NL + "                            }";
  protected final String TEXT_151 = NL + "                        }";
  protected final String TEXT_152 = NL + "                } ";
  protected final String TEXT_153 = NL + "                public void processAllContext() {";
  protected final String TEXT_154 = NL + "                        processContext_";
  protected final String TEXT_155 = "();";
  protected final String TEXT_156 = NL + "                }" + NL + "            }" + NL + "" + NL + "            new ContextProcessing().processAllContext();" + NL + "        } catch (java.io.IOException ie) {" + NL + "            System.err.println(\"Could not load context \"+contextStr);" + NL + "            ie.printStackTrace();" + NL + "        }" + NL + "" + NL + "        // get context value from parent directly" + NL + "        if (parentContextMap != null && !parentContextMap.isEmpty()) {";
  protected final String TEXT_157 = "if (parentContextMap.containsKey(\"";
  protected final String TEXT_158 = "\")) {" + NL + "                context.";
  protected final String TEXT_159 = " = (";
  protected final String TEXT_160 = ") parentContextMap.get(\"";
  protected final String TEXT_161 = "\");" + NL + "            }";
  protected final String TEXT_162 = NL + "        }" + NL + "" + NL + "        //Resume: init the resumeUtil" + NL + "        resumeEntryMethodName = ResumeUtil.getResumeEntryMethodName(resuming_checkpoint_path);" + NL + "        resumeUtil = new ResumeUtil(resuming_logs_dir_path, isChildJob, rootPid);" + NL + "        resumeUtil.initCommonInfo(pid, rootPid, fatherPid, projectName, jobName, contextStr, jobVersion);" + NL + "" + NL + "\t\tList<String> parametersToEncrypt = new java.util.ArrayList<String>();";
  protected final String TEXT_163 = NL + "\t\t\tparametersToEncrypt.add(\"";
  protected final String TEXT_164 = NL + "        //Resume: jobStart" + NL + "        resumeUtil.addLog(\"JOB_STARTED\", \"JOB:\" + jobName, parent_part_launcher, Thread.currentThread().getId() + \"\", \"\",\"\",\"\",\"\",resumeUtil.convertToJsonText(context,parametersToEncrypt));" + NL;
  ...
  protected final String TEXT_167 = NL + "    try {" + NL + "        runTrace.openSocket(!isChildJob);" + NL + "        runTrace.startThreadTrace(clientHost, portTraces);" + NL + "        if (runTrace.isPause()) {" + NL + "\t\t\twhile (runTrace.isPause()) {" + NL + "\t\t\t\tThread.sleep(100);" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "    } catch (java.io.IOException ioException) {" + NL + "        ioException.printStackTrace();" + NL + "    } catch (InterruptedException e) {" + NL + "\t\t\te.printStackTrace();" + NL + "\t}";
  protected final String TEXT_168 = NL + "\t";
  protected final String TEXT_169 = NL + "\t    java.util.concurrent.ConcurrentHashMap<Object, Object> concurrentHashMap = new java.util.concurrent.ConcurrentHashMap<Object, Object>();" + NL + "\t    globalMap.put(\"concurrentHashMap\", concurrentHashMap);" + NL + "\t";
  protected final String TEXT_170 = NL + NL + "    long startUsedMemory = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();" + NL + "    long endUsedMemory = 0;" + NL + "    long end = 0;" + NL + "" + NL + "    startTime = System.currentTimeMillis();";
  protected final String TEXT_171 = NL + "        java.net.ProxySelector proxySelectorOnStartJob = java.net.ProxySelector.getDefault();";
  protected final String TEXT_172 = ".addMessage(\"begin\");";
  protected final String TEXT_173 = NL + NL + "this.globalResumeTicket = true;//to run tPreJob" + NL;
  protected final String TEXT_174 = NL + "    System.err.println(\"Only one hadoop configuration is allowed in one job!\");";
  protected final String TEXT_175 = NL + "        try {";
  protected final String TEXT_176 = NL + "            ";
  protected final String TEXT_177 = "Process(globalMap);" + NL + "        } catch (java.lang.Exception e) {" + NL + "            e.printStackTrace();" + NL + "        }";
  protected final String TEXT_178 = NL + "\t\tif(enableLogStash) {" + NL + "\t        ";
  protected final String TEXT_179 = ".addJobStartMessage();" + NL + "\t        try {" + NL + "\t            ";
  protected final String TEXT_180 = "Process(globalMap);" + NL + "\t        } catch (java.lang.Exception e) {" + NL + "\t            e.printStackTrace();" + NL + "\t        }" + NL + "        }";
  protected final String TEXT_181 = NL + NL + "this.globalResumeTicket = false;//to run others jobs" + NL;
  protected final String TEXT_182 = "final Thread launchingThread = Thread.currentThread();";
  protected final String TEXT_183 = NL + "        runningThreadCount.add(1);" + NL + "        new Thread(){" + NL + "            public void run() {" + NL + "                java.util.Map threadRunResultMap = new java.util.HashMap();" + NL + "                threadRunResultMap.put(\"errorCode\", null);" + NL + "                threadRunResultMap.put(\"status\", \"\");" + NL + "                threadLocal.set(threadRunResultMap);" + NL;
  protected final String TEXT_184 = NL + "                ";
  protected final String TEXT_185 = NL + "                finally {" + NL + "                    Integer localErrorCode = (Integer)(((java.util.Map)threadLocal.get()).get(\"errorCode\"));" + NL + "                    String localStatus = (String)(((java.util.Map)threadLocal.get()).get(\"status\"));" + NL + "                    if (localErrorCode != null) {" + NL + "                        if (errorCode == null || localErrorCode.compareTo(errorCode) > 0) {" + NL + "                           errorCode = localErrorCode;" + NL + "                        }" + NL + "                    }" + NL + "                    if (!status.equals(\"failure\")){" + NL + "                        status = localStatus;" + NL + "                    }" + NL + "" + NL + "                    if (\"true\".equals(((java.util.Map) threadLocal.get()).get(\"JobInterrupted\"))) {" + NL + "                        launchingThread.interrupt();" + NL + "                    }" + NL + "" + NL + "                    runningThreadCount.add(-1);" + NL + "                }" + NL + "            }" + NL + "        }.start();" + NL;
  protected final String TEXT_186 = NL + "    boolean interrupted = false;" + NL + "    while (runningThreadCount.getCount() > 0) {" + NL + "        try {" + NL + "            Thread.sleep(10);" + NL + "        } catch (java.lang.InterruptedException e) {" + NL + "            interrupted = true;" + NL + "        } catch (java.lang.Exception e) {" + NL + "            e.printStackTrace();" + NL + "        }" + NL + "    }" + NL + "" + NL + "    if (interrupted) {" + NL + "        Thread.currentThread().interrupt();" + NL + "    }" + NL + NL;
  protected final String TEXT_187 = NL + NL + "this.globalResumeTicket = true;//to run tPostJob" + NL;
  protected final String TEXT_188 = NL + "        java.net.ProxySelector.setDefault(proxySelectorOnStartJob);";
  protected final String TEXT_189 = NL + "        end = System.currentTimeMillis();" + NL + "" + NL + "        if (watch) {" + NL + "            System.out.println((end-startTime)+\" milliseconds\");" + NL + "        }" + NL + "" + NL + "        endUsedMemory = Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory();" + NL + "        if (false) {" + NL + "            System.out.println((endUsedMemory - startUsedMemory) + \" bytes memory increase when running : ";
  protected final String TEXT_190 = "\");" + NL + "        }";
  protected final String TEXT_191 = ".addMessage(status==\"\"?\"end\":status, (end-startTime));" + NL + "        try {";
  protected final String TEXT_192 = ".addJobEndMessage(startTime, end, status);" + NL + "\t        try {" + NL + "\t            ";
  protected final String TEXT_193 = NL + "    closeJmsConnections();";
  protected final String TEXT_194 = NL + "    closeScpConnections();";
  protected final String TEXT_195 = NL + "if (execStat) {" + NL + "    runStat.updateStatOnJob(RunStat.JOBEND, fatherNode);" + NL + "    runStat.stopThreadStat();" + NL + "}";
  protected final String TEXT_196 = NL + "        runTrace.stopThreadTrace();";
  protected final String TEXT_197 = NL + "    int returnCode = 0;" + NL + "    if(errorCode == null) {" + NL + "         returnCode = status != null && status.equals(\"failure\") ? 1 : 0;" + NL + "    } else {" + NL + "         returnCode = errorCode.intValue();" + NL + "    }" + NL + "    resumeUtil.addLog(\"JOB_ENDED\", \"JOB:\" + jobName, parent_part_launcher, Thread.currentThread().getId() + \"\", \"\",\"\" + returnCode,\"\",\"\",\"\");" + NL + "" + NL + "    return returnCode;" + NL + "" + NL + "  }" + NL + "" + NL + "    // only for OSGi env" + NL + "    public void destroy() {";
  protected final String TEXT_198 = NL + "    closeSqlDbConnections();";
  protected final String TEXT_199 = NL + "    closeCassandraConnections();";
  protected final String TEXT_200 = NL + "    closeHBaseConnections();";
  protected final String TEXT_201 = NL + "    closeFtpConnections();";
  protected final String TEXT_202 = NL + "    closeS3Connections();";
  protected final String TEXT_203 = NL + "    closeLDAPConnections();";
  protected final String TEXT_204 = NL + "    closeMDMConnections();";
  protected final String TEXT_205 = NL + "    closePaloConnections();";
  protected final String TEXT_206 = NL + "    closeEXistConnections();";
  protected final String TEXT_207 = NL + "    closeGSConnections();";
  protected final String TEXT_208 = NL + NL + NL + "    }" + NL;
  protected final String TEXT_209 = NL + "    private void closeJmsConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_210 = NL + "            obj_conn = globalMap.remove(\"connection_";
  protected final String TEXT_211 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((javax.jms.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_212 = NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_213 = NL + "    private void closeScpConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_214 = NL + "            obj_conn = globalMap.remove(\"conn_";
  protected final String TEXT_215 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((ch.ethz.ssh2.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_216 = NL + "    private void closeSqlDbConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_217 = "\");" + NL + "            if (null != obj_conn) {" + NL + "                ((java.sql.Connection) obj_conn).close();" + NL + "            }";
  protected final String TEXT_218 = NL + "    private void closeCassandraConnections() {" + NL + "        try {" + NL + "            Object obj_cluster;" + NL + "            Object obj_conn;";
  protected final String TEXT_219 = NL + "            obj_cluster = globalMap.remove(\"cluster_";
  protected final String TEXT_220 = "\");" + NL + "            obj_conn = globalMap.remove(\"connection_";
  protected final String TEXT_221 = "\");" + NL + "            if(obj_conn != null) {" + NL + "                ((com.datastax.driver.core.Session) obj_conn).close();" + NL + "            }" + NL + "            if(obj_cluster != null) {" + NL + "                ((com.datastax.driver.core.Cluster) obj_cluster).close();" + NL + "            }";
  protected final String TEXT_222 = NL + "            obj_conn = globalMap.remove(\"cluster_";
  protected final String TEXT_223 = "\");" + NL + "            if(obj_conn!=null) {" + NL + "                ((me.prettyprint.hector.api.Cluster) obj_conn).getConnectionManager().shutdown();" + NL + "            }";
  protected final String TEXT_224 = NL + "    private void closeHBaseConnections() {" + NL + "        try {";
  protected final String TEXT_225 = NL + "   \t\t\torg.apache.hadoop.conf.Configuration conn_";
  protected final String TEXT_226 = " =(org.apache.hadoop.conf.Configuration)globalMap.get(\"conn_";
  protected final String TEXT_227 = "\");" + NL + "\t\t\tif(conn_";
  protected final String TEXT_228 = " != null )" + NL + "\t        {" + NL + "\t\t\t";
  protected final String TEXT_229 = NL + "                                org.apache.hadoop.hbase.client.HConnection hConnection_";
  protected final String TEXT_230 = " = org.apache.hadoop.hbase.client.HConnectionManager.getConnection(conn_";
  protected final String TEXT_231 = NL + "                                org.apache.hadoop.hbase.client.Connection hConnection_";
  protected final String TEXT_232 = " = org.apache.hadoop.hbase.client.ConnectionFactory.createConnection(conn_";
  protected final String TEXT_233 = NL + "\t\t        if ((hConnection_";
  protected final String TEXT_234 = " != null) && (!hConnection_";
  protected final String TEXT_235 = ".isClosed())) {" + NL + "\t\t\t\t    hConnection_";
  protected final String TEXT_236 = ".close();" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_237 = NL + "\t\t\t\torg.apache.hadoop.hbase.client.HConnectionManager.deleteConnection(conn_";
  protected final String TEXT_238 = ",true);" + NL + "\t\t\t";
  protected final String TEXT_239 = NL + "\t\t\t}" + NL + "      globalMap.remove(\"conn_";
  protected final String TEXT_240 = "\");" + NL + "\t";
  protected final String TEXT_241 = NL + "    private void closeFtpConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_242 = "\");" + NL + "            if (obj_conn != null) {";
  protected final String TEXT_243 = NL + "                ((com.jcraft.jsch.ChannelSftp) obj_conn).quit();";
  protected final String TEXT_244 = NL + "                ((org.apache.commons.net.ftp.FTPClient) obj_conn).disconnect();";
  protected final String TEXT_245 = NL + "            }";
  protected final String TEXT_246 = NL + "    private void closeS3Connections() {" + NL + "        try {";
  protected final String TEXT_247 = NL + "    \tcom.amazonaws.services.s3.AmazonS3Client conn_";
  protected final String TEXT_248 = " = (com.amazonaws.services.s3.AmazonS3Client)globalMap.get(\"conn_";
  protected final String TEXT_249 = "\");" + NL + "\t    if(conn_";
  protected final String TEXT_250 = " !=null){" + NL + "\t\t\tconn_";
  protected final String TEXT_251 = ".shutdown();" + NL + "\t\t}";
  protected final String TEXT_252 = NL + "    private void closeLDAPConnections() {" + NL + "        try {" + NL + "            Object obj_conn;";
  protected final String TEXT_253 = "\");" + NL + "            if (obj_conn != null) {" + NL + "                ((javax.naming.ldap.InitialLdapContext) obj_conn).close();" + NL + "            }";
  protected final String TEXT_254 = NL + "    private void closeMDMConnections() {" + NL + "        try {" + NL + "            java.util.Iterator keySets = globalMap.keySet().iterator();" + NL + "            while (keySets.hasNext()) {" + NL + "                String key = keySets.next().toString();" + NL + "                if (key.startsWith(\"TMDMService_tMDMConnection_\")) {" + NL + "                    org.talend.mdm.webservice.TMDMService service = (org.talend.mdm.webservice.TMDMService)globalMap.get(key);" + NL + "                    if (service != null) {" + NL + "                        service.logout(new org.talend.mdm.webservice.WSLogout());" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "        } catch (java.lang.Exception e) {" + NL + "        }" + NL + "    }";
  protected final String TEXT_255 = NL + NL;
  protected final String TEXT_256 = NL + "    private void closePaloConnections() {" + NL + "        try {";
  protected final String TEXT_257 = NL + "    \torg.talend.jpalo.paloconnection pConn_";
  protected final String TEXT_258 = " = (org.talend.jpalo.paloconnection)globalMap.get(\"pConn_";
  protected final String TEXT_259 = "\");" + NL + "\t    if(pConn_";
  protected final String TEXT_260 = " !=null){" + NL + "\t\t\t\t\tpConn_";
  protected final String TEXT_261 = ".logout();" + NL + "" + NL + "\t\t}";
  protected final String TEXT_262 = NL + "    private void closeEXistConnections() {" + NL + "        try {";
  protected final String TEXT_263 = NL + "\t\torg.xmldb.api.base.Collection col_";
  protected final String TEXT_264 = " = (org.xmldb.api.base.Collection)globalMap.get(\"col_";
  protected final String TEXT_265 = "\");" + NL + "\t    if(col_";
  protected final String TEXT_266 = " !=null){" + NL + "\t\t\t\t\tcol_";
  protected final String TEXT_267 = ".close();" + NL + "" + NL + "\t\t}";
  protected final String TEXT_268 = NL + "    private void closeGSConnections() {" + NL + "        try {";
  protected final String TEXT_269 = NL + NL + "    org.jets3t.service.impl.rest.httpclient.GoogleStorageService service_";
  protected final String TEXT_270 = " =" + NL + "            (org.jets3t.service.impl.rest.httpclient.GoogleStorageService)globalMap.get(\"service_";
  protected final String TEXT_271 = "\");" + NL + "    if(service_";
  protected final String TEXT_272 = " !=null){" + NL + "            service_";
  protected final String TEXT_273 = ".shutdown();" + NL + "    }";
  protected final String TEXT_274 = NL + "        //Don't need to close storage when use google storage api";
  protected final String TEXT_275 = NL + NL + "    private java.util.Map<String, Object> getSharedConnections4REST() {" + NL + "        java.util.Map<String, Object> connections = new java.util.HashMap<String, Object>();";
  protected final String TEXT_276 = NL + "            connections.put(\"connection_";
  protected final String TEXT_277 = "\", globalMap.get(\"connection_";
  protected final String TEXT_278 = "\"));" + NL + "            connections.put(\"session_";
  protected final String TEXT_279 = "\", globalMap.get(\"session_";
  protected final String TEXT_280 = "\"));";
  protected final String TEXT_281 = NL + "            connections.put(\"conn_";
  protected final String TEXT_282 = "\", globalMap.get(\"conn_";
