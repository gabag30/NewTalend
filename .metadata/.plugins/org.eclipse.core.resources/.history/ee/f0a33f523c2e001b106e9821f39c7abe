...
public class TMSSqlConnectionBeginJava
{
  ...
  protected final String TEXT_95 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_96 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_97 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_98 = NL + "\t\t\tif(\"com.mysql.cj.jdbc.Driver\".equals((String)globalMap.get(\"driverClass_";
  protected final String TEXT_99 = "\"))" + NL + "\t\t\t    && routines.system.BundleUtils.inOSGi()) {" + NL + "\t\t\t        Class.forName(\"com.mysql.cj.jdbc.AbandonedConnectionCleanupThread\")." + NL + "\t\t\t            getMethod(\"checkedShutdown\").invoke(null, (Object[]) null);" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_100 = NL + "\t\t\t\tconn_";
  protected final String TEXT_101 = NL + "\t\t\t\tlog.";
  protected final String TEXT_102 = "(\"";
  protected final String TEXT_103 = " - \" + ";
  protected final String TEXT_104 = ".getMessage());" + NL + "\t\t\t";
  protected final String TEXT_105 = NL + "\t    \t\tlog.";
  protected final String TEXT_106 = "\");" + NL + "\t\t\t";
  protected final String TEXT_107 = NL + "\t\t\t\tpstmt_";
  protected final String TEXT_108 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_109 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_110 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  protected final String TEXT_111 = ": pstmt_";
  protected final String TEXT_112 = ".executeBatch()) {" + NL + "\t\t\t\t\tcountSum_";
  protected final String TEXT_113 = " += (countEach_";
  protected final String TEXT_114 = " < 0 ? 0 : ";
  protected final String TEXT_115 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_116 = NL + "\t";
  protected final String TEXT_117 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_118 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tif (dataSources_";
  protected final String TEXT_119 = " == null) {";
  protected final String TEXT_120 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_121 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_122 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_123 = ".get(dsAlias_";
  protected final String TEXT_124 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_125 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_126 = " = dataSources_";
  protected final String TEXT_127 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_128 = ");" + NL + "\t}";
  protected final String TEXT_129 = NL + "\tif (null != conn_";
  protected final String TEXT_130 = ") {" + NL + "\t\t";
  protected final String TEXT_131 = NL + "\t}";
  protected final String TEXT_132 = NL + NL + "\tglobalMap.put(\"dbschema_";
  protected final String TEXT_133 = "\", ";
  protected final String TEXT_134 = ");" + NL + "" + NL + "\tglobalMap.put(\"db_";
  protected final String TEXT_135 = "\",  ";
  protected final String TEXT_136 = ");" + NL + "\t" + NL + "\tglobalMap.put(\"shareIdentitySetting_";
  protected final String TEXT_137 = ");" + NL + "" + NL + "\tglobalMap.put(\"driver_";
